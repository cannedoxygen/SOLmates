-- Fix User ID Types - Change from UUID to TEXT for Privy DID compatibility
-- This migration fixes the user_id parameter types to work with Privy DID strings

-- Drop existing functions
DROP FUNCTION IF EXISTS get_user_metrics(UUID) CASCADE;
DROP FUNCTION IF EXISTS get_user_engagement(UUID) CASCADE;

-- First, fix the table structures to use TEXT instead of UUID for user_id
