...
.method private static final findKFunction(Ljava/util/Collection;Ljava/lang/reflect/Method;)Lkotlin/reflect/KFunction;
    .locals 4
    .param p0, "$this$findKFunction"    # Ljava/util/Collection;
    ...
    .line 152
    .local v1, "callable":Lkotlin/reflect/KCallable;
    ...
    .line 154
    .end local v1    # "callable":Lkotlin/reflect/KCallable;
    :cond_1
    invoke-interface {p0}, Ljava/util/Collection;->iterator()Ljava/util/Iterator;
    ...
    .line 155
    .restart local v1    # "callable":Lkotlin/reflect/KCallable;
    instance-of v2, v1, Lkotlin/reflect/KFunction;
...
.method private static final findKProperty(Ljava/util/Collection;Ljava/lang/reflect/Field;)Lkotlin/reflect/KProperty;
    .locals 4
    .param p0, "$this$findKProperty"    # Ljava/util/Collection;
...
.method public static final getKotlinFunction(Ljava/lang/reflect/Constructor;)Lkotlin/reflect/KFunction;
    ...
    .line 177
    .local v5, "$i$a$-firstOrNull-ReflectJvmMapping$kotlinFunction$2":I
    ...
    .end local v5    # "$i$a$-firstOrNull-ReflectJvmMapping$kotlinFunction$2":I
    if-eqz v4, :cond_0
...
.method public static final getKotlinFunction(Ljava/lang/reflect/Method;)Lkotlin/reflect/KFunction;
    ...
    invoke-static {v1, p0}, Lkotlin/reflect/jvm/ReflectJvmMapping;->findKFunction(Ljava/util/Collection;Ljava/lang/reflect/Method;)Lkotlin/reflect/KFunction;
    ...
    invoke-static {v2}, Lkotlin/reflect/full/KClasses;->getCompanionObject(Lkotlin/reflect/KClass;)Lkotlin/reflect/KClass;

    move-result-object v2

    .line 136
    .local v2, "companionKClass":Lkotlin/reflect/KClass;
    if-eqz v2, :cond_1
    ...
    invoke-static {v3, v4, v5}, Lkotlin/reflect/jvm/internal/UtilKt;->getDeclaredMethodOrNull(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;

    move-result-object v3

    .line 138
    .local v3, "companionMethod":Ljava/lang/reflect/Method;
    if-eqz v3, :cond_1

    .line 139
    invoke-static {v2}, Lkotlin/reflect/full/KClasses;->getFunctions(Lkotlin/reflect/KClass;)Ljava/util/Collection;

    move-result-object v4

    invoke-static {v4, v3}, Lkotlin/reflect/jvm/ReflectJvmMapping;->findKFunction(Ljava/util/Collection;Ljava/lang/reflect/Method;)Lkotlin/reflect/KFunction;
    ...
    .line 139
    .local v4, "$i$a$-let-ReflectJvmMapping$kotlinFunction$1":I
    return-object v1

    .line 144
    .end local v0    # "kotlinPackage":Lkotlin/reflect/KDeclarationContainer;
    .end local v1    # "it":Lkotlin/reflect/KFunction;
    .end local v2    # "companionKClass":Lkotlin/reflect/KClass;
    .end local v3    # "companionMethod":Ljava/lang/reflect/Method;
    .end local v4    # "$i$a$-let-ReflectJvmMapping$kotlinFunction$1":I
    :cond_1
    invoke-virtual {p0}, Ljava/lang/reflect/Method;->getDeclaringClass()Ljava/lang/Class;
...
.method public static final getKotlinProperty(Ljava/lang/reflect/Field;)Lkotlin/reflect/KProperty;
    ...
    invoke-static {v1, p0}, Lkotlin/reflect/jvm/ReflectJvmMapping;->findKProperty(Ljava/util/Collection;Ljava/lang/reflect/Field;)Lkotlin/reflect/KProperty;
    ...
    invoke-static {v3, v4}, Lkotlin/reflect/jvm/internal/UtilKt;->getDeclaredFieldOrNull(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/reflect/Field;

    move-result-object v3

    .line 105
    .local v3, "companionField":Ljava/lang/reflect/Field;
    if-eqz v3, :cond_2
    ...
    invoke-static {v4, v3}, Lkotlin/reflect/jvm/ReflectJvmMapping;->findKProperty(Ljava/util/Collection;Ljava/lang/reflect/Field;)Lkotlin/reflect/KProperty;
    ...
    .line 180
    .local v1, "it":Lkotlin/reflect/KProperty;
    const/4 v4, 0x0

    .line 106
    .local v4, "$i$a$-let-ReflectJvmMapping$kotlinProperty$1":I
    return-object v1

    .line 111
    .end local v0    # "kotlinPackage":Lkotlin/reflect/KDeclarationContainer;
    .end local v1    # "it":Lkotlin/reflect/KProperty;
    .end local v2    # "companionKClass":Lkotlin/reflect/KClass;
    .end local v3    # "companionField":Ljava/lang/reflect/Field;
    .end local v4    # "$i$a$-let-ReflectJvmMapping$kotlinProperty$1":I
    :cond_2
    invoke-virtual {p0}, Ljava/lang/reflect/Field;->getDeclaringClass()Ljava/lang/Class;
