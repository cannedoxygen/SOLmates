...
.method private static bindToMessagingService(Landroid/content/Context;Landroid/content/Intent;Z)Lcom/google/android/gms/tasks/Task;
    ...
    .param p2, "isForegroundBroadcast"    # Z
    ...
    .line 126
    .local v0, "connection":Lcom/google/firebase/messaging/WithinAppServiceConnection;
    if-eqz p2, :cond_2
    ...
    invoke-virtual {v1, p0}, Lcom/google/firebase/messaging/ServiceStarter;->hasWakeLockPermission(Landroid/content/Context;)Z
    ...
    new-instance v3, Lcom/google/firebase/messaging/FcmBroadcastProcessor$$ExternalSyntheticLambda3;

    invoke-direct {v3}, Lcom/google/firebase/messaging/FcmBroadcastProcessor$$ExternalSyntheticLambda3;-><init>()V
...
.method static synthetic lambda$startMessagingService$2(Landroid/content/Context;Landroid/content/Intent;ZLcom/google/android/gms/tasks/Task;)Lcom/google/android/gms/tasks/Task;
    ...
    .param p3, "r"    # Lcom/google/android/gms/tasks/Task;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
        }
    ...
    invoke-direct {v2}, Lcom/google/firebase/messaging/FcmBroadcastProcessor$$ExternalSyntheticLambda0;-><init>()V
...
.method public static setServiceConnection(Lcom/google/firebase/messaging/WithinAppServiceConnection;)V
    .locals 2
    .param p0, "connection"    # Lcom/google/firebase/messaging/WithinAppServiceConnection;
...
.method public startMessagingService(Landroid/content/Context;Landroid/content/Intent;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-direct {v3, p1, p2}, Lcom/google/firebase/messaging/FcmBroadcastProcessor$$ExternalSyntheticLambda1;-><init>(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-direct {v4, p1, p2, v1}, Lcom/google/firebase/messaging/FcmBroadcastProcessor$$ExternalSyntheticLambda2;-><init>(Landroid/content/Context;Landroid/content/Intent;Z)V
