...
.method public create(Lorg/koin/core/instance/InstanceContext;)Ljava/lang/Object;
    ...
    sget-object v6, Lorg/koin/core/logger/Level;->ERROR:Lorg/koin/core/logger/Level;

    .local v6, "lvl$iv$iv":Lorg/koin/core/logger/Level;
    move-object v7, v3

    .local v7, "this_$iv$iv":Lorg/koin/core/logger/Logger;
    const/4 v8, 0x0

    .line 97
    .local v8, "$i$f$log":I
    invoke-virtual {v7, v6}, Lorg/koin/core/logger/Logger;->isAt(Lorg/koin/core/logger/Level;)Z

    move-result v9

    if-eqz v9, :cond_2

    invoke-virtual {v7, v6, v4}, Lorg/koin/core/logger/Logger;->display(Lorg/koin/core/logger/Level;Ljava/lang/String;)V
    ...
    .line 92
    .end local v6    # "lvl$iv$iv":Lorg/koin/core/logger/Level;
    .end local v7    # "this_$iv$iv":Lorg/koin/core/logger/Logger;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v1, v0, Lorg/koin/core/instance/InstanceFactory;->beanDefinition:Lorg/koin/core/definition/BeanDefinition;

    :cond_1
    move-object v0, v1

    .line 76
    .local v0, "other":Lorg/koin/core/definition/BeanDefinition;
    iget-object v1, p0, Lorg/koin/core/instance/InstanceFactory;->beanDefinition:Lorg/koin/core/definition/BeanDefinition;
