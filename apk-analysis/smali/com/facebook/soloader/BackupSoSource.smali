...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Z)V
    ...
    iput-object v0, p0, Lcom/facebook/soloader/BackupSoSource;->mZipSources:Ljava/util/ArrayList;
    ...
    new-instance v1, Lcom/facebook/soloader/ExtractFromZipSoSource;
    ...
    invoke-direct {v1, p1, p2, v2, v3}, Lcom/facebook/soloader/ExtractFromZipSoSource;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/io/File;Ljava/lang/String;)V
...
.method static synthetic access$000(Lcom/facebook/soloader/BackupSoSource;)Ljava/util/ArrayList;
    .locals 1
    .param p0, "x0"    # Lcom/facebook/soloader/BackupSoSource;
...
.method private addBackupsFromSplitApks(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 70
    .local v4, "splitApkDir":Ljava/lang/String;
    ...
    invoke-direct {v5, p1, p2, v6, v7}, Lcom/facebook/soloader/ExtractFromZipSoSource;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/io/File;Ljava/lang/String;)V

    .line 72
    .local v5, "splitApkSource":Lcom/facebook/soloader/ExtractFromZipSoSource;
    ...
    const-string v7, "adding backup source from split: "
    ...
    invoke-static {v0, v6}, Lcom/facebook/soloader/LogUtil;->w(Ljava/lang/String;Ljava/lang/String;)V

    .line 74
    iget-object v6, p0, Lcom/facebook/soloader/BackupSoSource;->mZipSources:Ljava/util/ArrayList;
    ...
    .line 69
    .end local v4    # "splitApkDir":Ljava/lang/String;
    .end local v5    # "splitApkSource":Lcom/facebook/soloader/ExtractFromZipSoSource;
    :cond_1
    ...
    const-string v2, "failed to read split apks"

    invoke-static {v0, v2, v1}, Lcom/facebook/soloader/LogUtil;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method protected getDepsBlock()[B
    ...
    .line 179
    .local v3, "canonicalFile":Ljava/io/File;
    ...
    .end local v3    # "canonicalFile":Ljava/io/File;
    :catchall_0
    move-exception v1
...
.method public peekAndPrepareSoSource(Ljava/lang/String;I)Z
    ...
    .line 115
    .local v7, "dso":Lcom/facebook/soloader/UnpackingSoSource$Dso;
    iget-object v8, v7, Lcom/facebook/soloader/UnpackingSoSource$Dso;->name:Ljava/lang/String;
    ...
    invoke-static {v6, v3}, Lcom/facebook/soloader/LogUtil;->e(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 114
    .end local v7    # "dso":Lcom/facebook/soloader/UnpackingSoSource$Dso;
    :cond_0
...
.method public recover(Landroid/content/Context;)Lcom/facebook/soloader/SoSource;
    ...
    .line 197
    .local v0, "recovered":Lcom/facebook/soloader/BackupSoSource;
    const/4 v1, 0x0

    :try_start_0
    invoke-virtual {v0, v1}, Lcom/facebook/soloader/BackupSoSource;->prepare(I)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public toString()Ljava/lang/String;
    ...
    iget v2, p0, Lcom/facebook/soloader/BackupSoSource;->flags:I
    ...
    iget-object v2, p0, Lcom/facebook/soloader/BackupSoSource;->mZipSources:Ljava/util/ArrayList;
