...
.method private final updateMaxHeaderLength()V
    ...
    iput v2, p0, Lcom/facebook/imageformat/ImageFormatChecker;->maxHeaderLength:I
...
.method public final determineImageFormat(Ljava/io/InputStream;)Lcom/facebook/imageformat/ImageFormat;
    ...
    sget-object v1, Lcom/facebook/imageformat/ImageFormatChecker;->Companion:Lcom/facebook/imageformat/ImageFormatChecker$Companion;

    iget v2, p0, Lcom/facebook/imageformat/ImageFormatChecker;->maxHeaderLength:I

    invoke-static {v1, v2, p1, v0}, Lcom/facebook/imageformat/ImageFormatChecker$Companion;->access$readHeaderFromStream(Lcom/facebook/imageformat/ImageFormatChecker$Companion;ILjava/io/InputStream;[B)I

    move-result v1

    .line 38
    .local v1, "headerSize":I
    iget-object v2, p0, Lcom/facebook/imageformat/ImageFormatChecker;->defaultFormatChecker:Lcom/facebook/imageformat/DefaultImageFormatChecker;

    invoke-virtual {v2, v0, v1}, Lcom/facebook/imageformat/DefaultImageFormatChecker;->determineFormat([BI)Lcom/facebook/imageformat/ImageFormat;
    ...
    .line 42
    :cond_0
    iget-object v3, p0, Lcom/facebook/imageformat/ImageFormatChecker;->customImageFormatCheckers:Ljava/util/List;
    ...
    check-cast v7, Lcom/facebook/imageformat/ImageFormat$FormatChecker;

    .local v7, "formatChecker":Lcom/facebook/imageformat/ImageFormat$FormatChecker;
    const/4 v8, 0x0

    .line 43
    .local v8, "$i$a$-forEach-ImageFormatChecker$determineImageFormat$1":I
    invoke-interface {v7, v0, v1}, Lcom/facebook/imageformat/ImageFormat$FormatChecker;->determineFormat([BI)Lcom/facebook/imageformat/ImageFormat;

    move-result-object v9

    .line 44
    .local v9, "format":Lcom/facebook/imageformat/ImageFormat;
    sget-object v10, Lcom/facebook/imageformat/ImageFormat;->UNKNOWN:Lcom/facebook/imageformat/ImageFormat;
    ...
    .line 153
    .end local v7    # "formatChecker":Lcom/facebook/imageformat/ImageFormat$FormatChecker;
    .end local v8    # "$i$a$-forEach-ImageFormatChecker$determineImageFormat$1":I
    .end local v9    # "format":Lcom/facebook/imageformat/ImageFormat;
    nop
...
.method public final setCustomImageFormatCheckers(Ljava/util/List;)V
    .locals 0
    .param p1, "customImageFormatCheckers"    # Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/List<",
