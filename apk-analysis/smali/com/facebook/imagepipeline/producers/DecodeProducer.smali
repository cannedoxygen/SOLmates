...
.method public constructor <init>(Lcom/facebook/common/memory/ByteArrayPool;Ljava/util/concurrent/Executor;Lcom/facebook/imagepipeline/decoder/ImageDecoder;Lcom/facebook/imagepipeline/decoder/ProgressiveJpegConfig;Lcom/facebook/imagepipeline/core/DownsampleMode;ZZLcom/facebook/imagepipeline/producers/Producer;ILcom/facebook/imagepipeline/core/CloseableReferenceFactory;Ljava/lang/Runnable;Lcom/facebook/common/internal/Supplier;)V
    ...
    .param p8, "inputProducer"    # Lcom/facebook/imagepipeline/producers/Producer;
    ...
    .param p12, "recoverFromDecoderOOM"    # Lcom/facebook/common/internal/Supplier;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lcom/facebook/common/memory/ByteArrayPool;",
...
.method public produceResults(Lcom/facebook/imagepipeline/producers/Consumer;Lcom/facebook/imagepipeline/producers/ProducerContext;)V
    ...
    .line 68
    sget-object v12, Lcom/facebook/imagepipeline/systrace/FrescoSystrace;->INSTANCE:Lcom/facebook/imagepipeline/systrace/FrescoSystrace;

    .local v12, "this_$iv":Lcom/facebook/imagepipeline/systrace/FrescoSystrace;
    const-string v13, "DecodeProducer#produceResults"

    .local v13, "name$iv":Ljava/lang/String;
    const/4 v14, 0x0

    .line 546
    .local v14, "$i$f$traceSection":I
    ...
    .line 69
    .local v0, "$i$a$-traceSection-DecodeProducer$produceResults$1":I
    ...
    .line 71
    .local v15, "imageRequest":Lcom/facebook/imagepipeline/request/ImageRequest;
    invoke-virtual {v15}, Lcom/facebook/imagepipeline/request/ImageRequest;->getSourceUri()Landroid/net/Uri;
    ...
    .line 74
    iget-boolean v5, v9, Lcom/facebook/imagepipeline/producers/DecodeProducer;->decodeCancellationEnabled:Z

    iget v6, v9, Lcom/facebook/imagepipeline/producers/DecodeProducer;->maxBitmapSize:I
    ...
    check-cast v7, Lcom/facebook/imagepipeline/producers/DecodeProducer$ProgressiveDecoder;
    ...
    iget-object v1, v9, Lcom/facebook/imagepipeline/producers/DecodeProducer;->byteArrayPool:Lcom/facebook/common/memory/ByteArrayPool;
    ...
    new-instance v16, Lcom/facebook/imagepipeline/producers/DecodeProducer$NetworkImagesProgressiveDecoder;
    ...
    .line 81
    iget-object v6, v9, Lcom/facebook/imagepipeline/producers/DecodeProducer;->progressiveJpegConfig:Lcom/facebook/imagepipeline/decoder/ProgressiveJpegConfig;

    .line 82
    iget-boolean v7, v9, Lcom/facebook/imagepipeline/producers/DecodeProducer;->decodeCancellationEnabled:Z

    .line 83
    iget v8, v9, Lcom/facebook/imagepipeline/producers/DecodeProducer;->maxBitmapSize:I
    ...
    iget-object v2, v9, Lcom/facebook/imagepipeline/producers/DecodeProducer;->inputProducer:Lcom/facebook/imagepipeline/producers/Producer;

    move-object v3, v1

    check-cast v3, Lcom/facebook/imagepipeline/producers/Consumer;

    invoke-interface {v2, v3, v10}, Lcom/facebook/imagepipeline/producers/Producer;->produceResults(Lcom/facebook/imagepipeline/producers/Consumer;Lcom/facebook/imagepipeline/producers/ProducerContext;)V

    .line 86
    nop

    .line 547
    .end local v0    # "$i$a$-traceSection-DecodeProducer$produceResults$1":I
    .end local v1    # "progressiveDecoder":Lcom/facebook/imagepipeline/producers/DecodeProducer$ProgressiveDecoder;
    .end local v15    # "imageRequest":Lcom/facebook/imagepipeline/request/ImageRequest;
    goto :goto_2

    .line 550
    :cond_1
    invoke-static {v13}, Lcom/facebook/imagepipeline/systrace/FrescoSystrace;->beginSection(Ljava/lang/String;)V
    ...
    .line 69
    .restart local v0    # "$i$a$-traceSection-DecodeProducer$produceResults$1":I
    :try_start_0
    invoke-interface/range {p2 .. p2}, Lcom/facebook/imagepipeline/producers/ProducerContext;->getImageRequest()Lcom/facebook/imagepipeline/request/ImageRequest;
    ...
    .line 71
    .restart local v15    # "imageRequest":Lcom/facebook/imagepipeline/request/ImageRequest;
    invoke-virtual {v15}, Lcom/facebook/imagepipeline/request/ImageRequest;->getSourceUri()Landroid/net/Uri;
    ...
    .line 77
    .restart local v5    # "jpegParser":Lcom/facebook/imagepipeline/decoder/ProgressiveJpegParser;
    new-instance v16, Lcom/facebook/imagepipeline/producers/DecodeProducer$NetworkImagesProgressiveDecoder;
    ...
    .line 86
    .end local v12    # "this_$iv":Lcom/facebook/imagepipeline/systrace/FrescoSystrace;
    .end local v13    # "name$iv":Ljava/lang/String;
    .end local v14    # "$i$f$traceSection":I
    :goto_2
    return-void

    .line 554
    .restart local v12    # "this_$iv":Lcom/facebook/imagepipeline/systrace/FrescoSystrace;
    .restart local v13    # "name$iv":Ljava/lang/String;
    .restart local v14    # "$i$f$traceSection":I
    :catchall_0
    move-exception v0
