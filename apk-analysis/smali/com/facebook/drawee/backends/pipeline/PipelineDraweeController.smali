...
.method protected getImageInfo(Lcom/facebook/common/references/CloseableReference;)Lcom/facebook/imagepipeline/image/ImageInfo;
    ...
    invoke-interface {v0}, Lcom/facebook/imagepipeline/image/CloseableImage;->getImageInfo()Lcom/facebook/imagepipeline/image/ImageInfo;
...
.method protected declared-synchronized initializePerformanceMonitoring(Lcom/facebook/fresco/ui/common/ImagePerfDataListener;Lcom/facebook/drawee/controller/AbstractDraweeControllerBuilder;Lcom/facebook/common/internal/Supplier;)V
    ...
    .line 149
    .end local p1    # "imagePerfDataListener":Lcom/facebook/fresco/ui/common/ImagePerfDataListener;
...
.method protected updateDebugOverlay(Lcom/facebook/imagepipeline/image/CloseableImage;Lcom/facebook/drawee/debug/DebugControllerOverlayDrawable;)V
    ...
    .line 336
    .local v0, "draweeHierarchy":Lcom/facebook/drawee/interfaces/DraweeHierarchy;
    const/4 v1, 0x0

    .line 337
    .local v1, "scaleType":Lcom/facebook/drawee/drawable/ScalingUtils$ScaleType;
    if-eqz v0, :cond_1
    ...
    .line 340
    .local v2, "scaleTypeDrawable":Lcom/facebook/drawee/drawable/ScaleTypeDrawable;
    if-eqz v2, :cond_0
    ...
    .line 342
    .end local v2    # "scaleTypeDrawable":Lcom/facebook/drawee/drawable/ScaleTypeDrawable;
    :cond_1
    ...
    .line 345
    .local v2, "callerContextString":Ljava/lang/String;
    if-eqz v2, :cond_2

    .line 346
    const-string v3, "cc"

    invoke-virtual {p2, v3, v2}, Lcom/facebook/drawee/debug/DebugControllerOverlayDrawable;->addAdditionalData(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p2, v3, v4}, Lcom/facebook/drawee/debug/DebugControllerOverlayDrawable;->setDimensions(II)V
    ...
    invoke-virtual {p2, v3}, Lcom/facebook/drawee/debug/DebugControllerOverlayDrawable;->setImageSize(I)V
