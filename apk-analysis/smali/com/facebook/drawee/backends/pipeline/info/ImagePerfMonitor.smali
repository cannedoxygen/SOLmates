...
.method public constructor <init>(Lcom/facebook/common/time/MonotonicClock;Lcom/facebook/drawee/backends/pipeline/PipelineDraweeController;Lcom/facebook/common/internal/Supplier;)V
    ...
    .line 51
    new-instance v0, Lcom/facebook/fresco/ui/common/ImagePerfState;

    invoke-direct {v0}, Lcom/facebook/fresco/ui/common/ImagePerfState;-><init>()V

    iput-object v0, p0, Lcom/facebook/drawee/backends/pipeline/info/ImagePerfMonitor;->mImagePerfState:Lcom/facebook/fresco/ui/common/ImagePerfState;
...
.method public addImagePerfDataListener(Lcom/facebook/fresco/ui/common/ImagePerfDataListener;)V
    .locals 1
    .param p1, "imagePerfDataListener"    # Lcom/facebook/fresco/ui/common/ImagePerfDataListener;
        .annotation runtime Ljavax/annotation/Nullable;
        .end annotation
    .end param
...
.method public addViewportData()V
    ...
    invoke-virtual {v2, v3}, Lcom/facebook/fresco/ui/common/ImagePerfState;->setOnScreenWidth(I)V
    ...
    invoke-virtual {v2, v3}, Lcom/facebook/fresco/ui/common/ImagePerfState;->setOnScreenHeight(I)V
...
.method public notifyListenersOfVisibilityStateUpdate(Lcom/facebook/fresco/ui/common/ImagePerfState;Lcom/facebook/fresco/ui/common/VisibilityState;)V
    ...
    .line 121
    .local v0, "data":Lcom/facebook/fresco/ui/common/ImagePerfData;
    ...
    check-cast v2, Lcom/facebook/fresco/ui/common/ImagePerfDataListener;

    .line 122
    .local v2, "listener":Lcom/facebook/fresco/ui/common/ImagePerfDataListener;
    invoke-interface {v2, v0, p2}, Lcom/facebook/fresco/ui/common/ImagePerfDataListener;->onImageVisibilityUpdated(Lcom/facebook/fresco/ui/common/ImagePerfData;Lcom/facebook/fresco/ui/common/VisibilityState;)V

    .line 123
    .end local v2    # "listener":Lcom/facebook/fresco/ui/common/ImagePerfDataListener;
    goto :goto_0
    ...
    .line 117
    .end local v0    # "data":Lcom/facebook/fresco/ui/common/ImagePerfData;
    :cond_2
    :goto_1
    return-void
.end method
...
.method public notifyStatusUpdated(Lcom/facebook/fresco/ui/common/ImagePerfState;Lcom/facebook/fresco/ui/common/ImageLoadStatus;)V
    ...
    .line 109
    .local v2, "listener":Lcom/facebook/fresco/ui/common/ImagePerfDataListener;
    invoke-interface {v2, v0, p2}, Lcom/facebook/fresco/ui/common/ImagePerfDataListener;->onImageLoadStatusUpdated(Lcom/facebook/fresco/ui/common/ImagePerfData;Lcom/facebook/fresco/ui/common/ImageLoadStatus;)V
