...
.method public constructor <init>(Lcom/facebook/common/time/MonotonicClock;Lcom/facebook/fresco/ui/common/ImagePerfState;Lcom/facebook/fresco/ui/common/ImagePerfNotifier;Lcom/facebook/common/internal/Supplier;)V
    ...
    .param p3, "globalImagePerfNotifier"    # Lcom/facebook/fresco/ui/common/ImagePerfNotifier;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public constructor <init>(Lcom/facebook/common/time/MonotonicClock;Lcom/facebook/fresco/ui/common/ImagePerfState;Lcom/facebook/fresco/ui/common/ImagePerfNotifier;Lcom/facebook/common/internal/Supplier;Z)V
    ...
    .param p2, "imagePerfState"    # Lcom/facebook/fresco/ui/common/ImagePerfState;
    .param p3, "globalImagePerfNotifier"    # Lcom/facebook/fresco/ui/common/ImagePerfNotifier;
    .param p5, "reportVisibleOnSubmitAndRelease"    # Z
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lcom/facebook/common/time/MonotonicClock;",
...
.method private declared-synchronized initHandler()V
    ...
    iget-object v3, p0, Lcom/facebook/drawee/backends/pipeline/info/internal/ImagePerfControllerListener2;->mImagePerfNotifier:Lcom/facebook/fresco/ui/common/ImagePerfNotifier;

    iget-object v4, p0, Lcom/facebook/drawee/backends/pipeline/info/internal/ImagePerfControllerListener2;->mLocalImagePerfNotifier:Lcom/facebook/fresco/ui/common/ImagePerfNotifier;

    invoke-direct {v2, v1, v3, v4}, Lcom/facebook/drawee/backends/pipeline/info/internal/ImagePerfControllerListener2$LogHandler;-><init>(Landroid/os/Looper;Lcom/facebook/fresco/ui/common/ImagePerfNotifier;Lcom/facebook/fresco/ui/common/ImagePerfNotifier;)V

    sput-object v2, Lcom/facebook/drawee/backends/pipeline/info/internal/ImagePerfControllerListener2;->sHandler:Lcom/facebook/drawee/backends/pipeline/info/internal/ImagePerfControllerListener2$LogHandler;
    :try_end_1
...
.method private reportViewInvisible(Lcom/facebook/fresco/ui/common/ImagePerfState;J)V
    .locals 1
    .param p1, "state"    # Lcom/facebook/fresco/ui/common/ImagePerfState;
    .param p2, "time"    # J
    ...
    invoke-direct {p0, p1, v0}, Lcom/facebook/drawee/backends/pipeline/info/internal/ImagePerfControllerListener2;->updateVisibility(Lcom/facebook/fresco/ui/common/ImagePerfState;Lcom/facebook/fresco/ui/common/VisibilityState;)V
...
.method private updateStatus(Lcom/facebook/fresco/ui/common/ImagePerfState;Lcom/facebook/fresco/ui/common/ImageLoadStatus;)V
    .locals 2
    .param p1, "state"    # Lcom/facebook/fresco/ui/common/ImagePerfState;
    .param p2, "imageLoadStatus"    # Lcom/facebook/fresco/ui/common/ImageLoadStatus;
    ...
    invoke-virtual {v1, v0}, Lcom/facebook/drawee/backends/pipeline/info/internal/ImagePerfControllerListener2$LogHandler;->sendMessage(Landroid/os/Message;)Z
    ...
    .line 272
    .local v0, "localImagePerfNotifier":Lcom/facebook/fresco/ui/common/ImagePerfNotifier;
    if-eqz v0, :cond_1
    ...
    .line 276
    .end local v0    # "localImagePerfNotifier":Lcom/facebook/fresco/ui/common/ImagePerfNotifier;
    :cond_1
    :goto_0
    return-void
.end method
...
.method private updateVisibility(Lcom/facebook/fresco/ui/common/ImagePerfState;Lcom/facebook/fresco/ui/common/VisibilityState;)V
    .locals 2
    .param p1, "state"    # Lcom/facebook/fresco/ui/common/ImagePerfState;
    .param p2, "visibilityState"    # Lcom/facebook/fresco/ui/common/VisibilityState;
...
.method public onEmptyEvent(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v1}, Lcom/facebook/fresco/ui/common/ImagePerfState;->setImageLoadStatus(Lcom/facebook/fresco/ui/common/ImageLoadStatus;)V
    ...
    .line 319
    .local v1, "localImagePerfNotifier":Lcom/facebook/fresco/ui/common/ImagePerfNotifier;
    if-eqz v1, :cond_0
...
.method public onFailure(Ljava/lang/String;Ljava/lang/Throwable;Lcom/facebook/fresco/ui/common/ControllerListener2$Extras;)V
    ...
    .line 190
    .local v2, "state":Lcom/facebook/fresco/ui/common/ImagePerfState;
    ...
    invoke-direct {p0, v2, v3}, Lcom/facebook/drawee/backends/pipeline/info/internal/ImagePerfControllerListener2;->updateStatus(Lcom/facebook/fresco/ui/common/ImagePerfState;Lcom/facebook/fresco/ui/common/ImageLoadStatus;)V
...
.method public onImageDrawn(Ljava/lang/String;Lcom/facebook/imagepipeline/image/ImageInfo;Lcom/facebook/fresco/ui/common/DimensionsInfo;)V
    ...
    invoke-direct {p0, v0, v1}, Lcom/facebook/drawee/backends/pipeline/info/internal/ImagePerfControllerListener2;->updateStatus(Lcom/facebook/fresco/ui/common/ImagePerfState;Lcom/facebook/fresco/ui/common/ImageLoadStatus;)V
...
.method public onIntermediateImageSet(Ljava/lang/String;Lcom/facebook/imagepipeline/image/ImageInfo;)V
    ...
    .line 163
    sget-object v3, Lcom/facebook/fresco/ui/common/ImageLoadStatus;->INTERMEDIATE_AVAILABLE:Lcom/facebook/fresco/ui/common/ImageLoadStatus;
...
.method public onRelease(Ljava/lang/String;Lcom/facebook/fresco/ui/common/ControllerListener2$Extras;)V
    ...
    .line 211
    .local v3, "lastImageLoadStatus":Lcom/facebook/fresco/ui/common/ImageLoadStatus;
    ...
    sget-object v4, Lcom/facebook/fresco/ui/common/ImageLoadStatus;->DRAW:Lcom/facebook/fresco/ui/common/ImageLoadStatus;
    ...
    invoke-direct {p0, v2, v4}, Lcom/facebook/drawee/backends/pipeline/info/internal/ImagePerfControllerListener2;->updateStatus(Lcom/facebook/fresco/ui/common/ImagePerfState;Lcom/facebook/fresco/ui/common/ImageLoadStatus;)V

    .line 218
    :cond_0
    sget-object v4, Lcom/facebook/fresco/ui/common/ImageLoadStatus;->RELEASED:Lcom/facebook/fresco/ui/common/ImageLoadStatus;

    invoke-direct {p0, v2, v4}, Lcom/facebook/drawee/backends/pipeline/info/internal/ImagePerfControllerListener2;->updateStatus(Lcom/facebook/fresco/ui/common/ImagePerfState;Lcom/facebook/fresco/ui/common/ImageLoadStatus;)V

    .line 220
    iget-boolean v4, p0, Lcom/facebook/drawee/backends/pipeline/info/internal/ImagePerfControllerListener2;->mReportVisibleOnSubmitAndRelease:Z
...
.method public onSubmit(Ljava/lang/String;Ljava/lang/Object;Lcom/facebook/fresco/ui/common/ControllerListener2$Extras;)V
    ...
    .line 147
    sget-object v3, Lcom/facebook/fresco/ui/common/ImageLoadStatus;->REQUESTED:Lcom/facebook/fresco/ui/common/ImageLoadStatus;

    invoke-direct {p0, v2, v3}, Lcom/facebook/drawee/backends/pipeline/info/internal/ImagePerfControllerListener2;->updateStatus(Lcom/facebook/fresco/ui/common/ImagePerfState;Lcom/facebook/fresco/ui/common/ImageLoadStatus;)V

    .line 148
    iget-boolean v3, p0, Lcom/facebook/drawee/backends/pipeline/info/internal/ImagePerfControllerListener2;->mReportVisibleOnSubmitAndRelease:Z
...
.method public onVisibilityChange(Z)V
    ...
    invoke-virtual {p0, v0, v1, v2}, Lcom/facebook/drawee/backends/pipeline/info/internal/ImagePerfControllerListener2;->reportViewVisible(Lcom/facebook/fresco/ui/common/ImagePerfState;J)V
    ...
    invoke-direct {p0, v0, v1, v2}, Lcom/facebook/drawee/backends/pipeline/info/internal/ImagePerfControllerListener2;->reportViewInvisible(Lcom/facebook/fresco/ui/common/ImagePerfState;J)V
