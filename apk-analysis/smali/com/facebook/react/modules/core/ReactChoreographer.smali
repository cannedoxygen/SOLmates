...
.method private static final _init_$lambda$2(Lcom/facebook/react/modules/core/ReactChoreographer;Lcom/facebook/react/internal/ChoreographerProvider;)V
    .locals 1
    .param p0, "this$0"    # Lcom/facebook/react/modules/core/ReactChoreographer;
    .param p1, "$choreographerProvider"    # Lcom/facebook/react/internal/ChoreographerProvider;
    ...
    iput-object v0, p0, Lcom/facebook/react/modules/core/ReactChoreographer;->choreographer$1:Lcom/facebook/react/internal/ChoreographerProvider$Choreographer;
...
.method public static final synthetic access$setChoreographer$cp(Lcom/facebook/react/modules/core/ReactChoreographer;)V
    .locals 0
    .param p0, "<set-?>"    # Lcom/facebook/react/modules/core/ReactChoreographer;
...
.method private static final frameCallback$lambda$1(Lcom/facebook/react/modules/core/ReactChoreographer;J)V
    ...
    .line 53
    .local v1, "$i$a$-synchronized-ReactChoreographer$frameCallback$1$1":I
    const/4 v2, 0x0

    :try_start_0
    iput-boolean v2, p0, Lcom/facebook/react/modules/core/ReactChoreographer;->hasPostedCallback:Z

    .line 54
    const/4 v2, 0x0

    .local v2, "i":I
    iget-object v3, p0, Lcom/facebook/react/modules/core/ReactChoreographer;->callbackQueues:[Ljava/util/ArrayDeque;
    ...
    .line 56
    .local v4, "callbackQueue":Ljava/util/ArrayDeque;
    invoke-virtual {v4}, Ljava/util/ArrayDeque;->size()I

    move-result v5

    .line 57
    .local v5, "initialLength":I
    const/4 v6, 0x0
    ...
    .line 59
    .local v7, "frameCallback":Landroid/view/Choreographer$FrameCallback;
    if-eqz v7, :cond_0
    ...
    .line 61
    iget v8, p0, Lcom/facebook/react/modules/core/ReactChoreographer;->totalCallbacks:I

    add-int/lit8 v8, v8, -0x1

    iput v8, p0, Lcom/facebook/react/modules/core/ReactChoreographer;->totalCallbacks:I
    ...
    invoke-static {v8, v9}, Lcom/facebook/common/logging/FLog;->e(Ljava/lang/String;Ljava/lang/String;)V

    .line 57
    .end local v7    # "frameCallback":Landroid/view/Choreographer$FrameCallback;
    :goto_2
    ...
    .line 54
    .end local v4    # "callbackQueue":Ljava/util/ArrayDeque;
    .end local v5    # "initialLength":I
    .end local v6    # "callback":I
    :cond_1
    add-int/lit8 v2, v2, 0x1
    ...
    .end local v1    # "$i$a$-synchronized-ReactChoreographer$frameCallback$1$1":I
...
.method private final postFrameCallbackOnChoreographer()V
    ...
    .line 102
    .local v0, "choreographer":Lcom/facebook/react/internal/ChoreographerProvider$Choreographer;
    if-nez v0, :cond_0

    .line 104
    new-instance v1, Lcom/facebook/react/modules/core/ReactChoreographer$$ExternalSyntheticLambda2;

    invoke-direct {v1, p0}, Lcom/facebook/react/modules/core/ReactChoreographer$$ExternalSyntheticLambda2;-><init>(Lcom/facebook/react/modules/core/ReactChoreographer;)V
    ...
    .line 112
    .end local v0    # "choreographer":Lcom/facebook/react/internal/ChoreographerProvider$Choreographer;
    :cond_1
    :goto_0
    return-void
.end method
...
.method private static final postFrameCallbackOnChoreographer$lambda$6(Lcom/facebook/react/modules/core/ReactChoreographer;)V
    ...
    .line 105
    .local v1, "$i$a$-synchronized-ReactChoreographer$postFrameCallbackOnChoreographer$1$1":I
    :try_start_0
    invoke-direct {p0}, Lcom/facebook/react/modules/core/ReactChoreographer;->postFrameCallbackOnChoreographer()V

    .end local v1    # "$i$a$-synchronized-ReactChoreographer$postFrameCallbackOnChoreographer$1$1":I
    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final postFrameCallback(Lcom/facebook/react/modules/core/ReactChoreographer$CallbackType;Landroid/view/Choreographer$FrameCallback;)V
    ...
    .line 77
    .local v1, "$i$a$-synchronized-ReactChoreographer$postFrameCallback$1":I
    :try_start_0
    iget-object v2, p0, Lcom/facebook/react/modules/core/ReactChoreographer;->callbackQueues:[Ljava/util/ArrayDeque;

    invoke-virtual {p1}, Lcom/facebook/react/modules/core/ReactChoreographer$CallbackType;->getOrder$ReactAndroid_debug()I
    ...
    .line 78
    iget v2, p0, Lcom/facebook/react/modules/core/ReactChoreographer;->totalCallbacks:I

    const/4 v3, 0x1

    add-int/2addr v2, v3

    iput v2, p0, Lcom/facebook/react/modules/core/ReactChoreographer;->totalCallbacks:I
    ...
    .end local v1    # "$i$a$-synchronized-ReactChoreographer$postFrameCallback$1":I
    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final removeFrameCallback(Lcom/facebook/react/modules/core/ReactChoreographer$CallbackType;Landroid/view/Choreographer$FrameCallback;)V
    .locals 4
    .param p1, "type"    # Lcom/facebook/react/modules/core/ReactChoreographer$CallbackType;
    .param p2, "frameCallback"    # Landroid/view/Choreographer$FrameCallback;
    ...
    .line 86
    .local v1, "$i$a$-synchronized-ReactChoreographer$removeFrameCallback$1":I
    :try_start_0
    iget-object v2, p0, Lcom/facebook/react/modules/core/ReactChoreographer;->callbackQueues:[Ljava/util/ArrayDeque;
    ...
    invoke-virtual {v2, p2}, Ljava/util/ArrayDeque;->removeFirstOccurrence(Ljava/lang/Object;)Z
    ...
    const-string v3, "Tried to remove non-existent frame callback"
    ...
    .end local v1    # "$i$a$-synchronized-ReactChoreographer$removeFrameCallback$1":I
    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
