...
.method public openFile(Landroid/net/Uri;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    ...
    .restart local v4    # "pipe":[Landroid/os/ParcelFileDescriptor;
    .restart local v5    # "readSide":Landroid/os/ParcelFileDescriptor;
    .restart local v6    # "writeSide":Landroid/os/ParcelFileDescriptor;
    ...
    invoke-direct {v1, p0, v6, v3}, Lcom/facebook/react/modules/blob/BlobProvider$1;-><init>(Lcom/facebook/react/modules/blob/BlobProvider;Landroid/os/ParcelFileDescriptor;[B)V

    .line 121
    .local v1, "writer":Ljava/lang/Runnable;
    iget-object v7, p0, Lcom/facebook/react/modules/blob/BlobProvider;->executor:Ljava/util/concurrent/ExecutorService;

    invoke-interface {v7, v1}, Ljava/util/concurrent/ExecutorService;->submit(Ljava/lang/Runnable;)Ljava/util/concurrent/Future;

    .line 124
    .end local v1    # "writer":Ljava/lang/Runnable;
    :goto_1
    return-object v5
    ...
    const-string v5, ", blob not found."
