...
.method private final createEventDataSource()Lcom/facebook/react/bridge/WritableMap;
    ...
    .local v1, "$this$createEventDataSource_u24lambda_u241":Lcom/facebook/react/bridge/WritableMap;
    const/4 v2, 0x0

    .line 53
    .local v2, "$i$a$-apply-ImageLoadEvent$createEventDataSource$1":I
    const-string/jumbo v3, "uri"

    iget-object v4, p0, Lcom/facebook/react/views/image/ImageLoadEvent;->sourceUri:Ljava/lang/String;

    invoke-interface {v1, v3, v4}, Lcom/facebook/react/bridge/WritableMap;->putString(Ljava/lang/String;Ljava/lang/String;)V

    .line 54
    iget v3, p0, Lcom/facebook/react/views/image/ImageLoadEvent;->width:I
    ...
    .line 55
    iget v3, p0, Lcom/facebook/react/views/image/ImageLoadEvent;->height:I
    ...
    .line 52
    .end local v1    # "$this$createEventDataSource_u24lambda_u241":Lcom/facebook/react/bridge/WritableMap;
    .end local v2    # "$i$a$-apply-ImageLoadEvent$createEventDataSource$1":I
...
.method protected getEventData()Lcom/facebook/react/bridge/WritableMap;
    ...
    .local v1, "$this$getEventData_u24lambda_u240":Lcom/facebook/react/bridge/WritableMap;
    const/4 v2, 0x0

    .line 40
    .local v2, "$i$a$-apply-ImageLoadEvent$getEventData$1":I
    iget v3, p0, Lcom/facebook/react/views/image/ImageLoadEvent;->eventType:I
    ...
    iget v4, p0, Lcom/facebook/react/views/image/ImageLoadEvent;->loaded:I
    ...
    iget v4, p0, Lcom/facebook/react/views/image/ImageLoadEvent;->total:I

    invoke-interface {v1, v3, v4}, Lcom/facebook/react/bridge/WritableMap;->putInt(Ljava/lang/String;I)V

    .line 44
    iget v3, p0, Lcom/facebook/react/views/image/ImageLoadEvent;->loaded:I

    int-to-double v3, v3

    iget v5, p0, Lcom/facebook/react/views/image/ImageLoadEvent;->total:I
    ...
    invoke-interface {v1, v4, v3}, Lcom/facebook/react/bridge/WritableMap;->putMap(Ljava/lang/String;Lcom/facebook/react/bridge/ReadableMap;)V
    ...
    iget-object v4, p0, Lcom/facebook/react/views/image/ImageLoadEvent;->errorMessage:Ljava/lang/String;
    ...
    .line 39
    .end local v1    # "$this$getEventData_u24lambda_u240":Lcom/facebook/react/bridge/WritableMap;
    .end local v2    # "$i$a$-apply-ImageLoadEvent$getEventData$1":I
    nop
