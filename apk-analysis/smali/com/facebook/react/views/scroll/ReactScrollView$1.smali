...
.method public run()V
    ...
    .line 740
    .local v1, "nativeAnimated":Lcom/facebook/react/animated/NativeAnimatedModule;
    if-eqz v1, :cond_2

    .line 741
    iget-object v2, p0, Lcom/facebook/react/views/scroll/ReactScrollView$1;->this$0:Lcom/facebook/react/views/scroll/ReactScrollView;

    invoke-virtual {v2}, Lcom/facebook/react/views/scroll/ReactScrollView;->getId()I

    move-result v2

    invoke-virtual {v1, v2}, Lcom/facebook/react/animated/NativeAnimatedModule;->userDrivenScrollEnded(I)V

    .line 744
    .end local v1    # "nativeAnimated":Lcom/facebook/react/animated/NativeAnimatedModule;
    :cond_2
    ...
    invoke-static {v1}, Lcom/facebook/react/views/scroll/ReactScrollView;->-$$Nest$mdisableFpsListener(Lcom/facebook/react/views/scroll/ReactScrollView;)V
