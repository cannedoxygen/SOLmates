...
.method public constructor <init>(Lcom/facebook/react/modules/debug/interfaces/DeveloperSettings;Landroid/content/Context;Lcom/facebook/react/packagerconnection/PackagerConnectionSettings;)V
    .locals 4
    .param p1, "developerSettings"    # Lcom/facebook/react/modules/debug/interfaces/DeveloperSettings;
    .param p2, "applicationContext"    # Landroid/content/Context;
    .param p3, "packagerConnectionSettings"    # Lcom/facebook/react/packagerconnection/PackagerConnectionSettings;
    ...
    .line 127
    new-instance v0, Lcom/facebook/react/devsupport/PackagerStatusCheck;

    iget-object v1, p0, Lcom/facebook/react/devsupport/DevServerHelper;->mClient:Lokhttp3/OkHttpClient;

    invoke-direct {v0, v1}, Lcom/facebook/react/devsupport/PackagerStatusCheck;-><init>(Lokhttp3/OkHttpClient;)V

    iput-object v0, p0, Lcom/facebook/react/devsupport/DevServerHelper;->mPackagerStatusCheck:Lcom/facebook/react/devsupport/PackagerStatusCheck;
    ...
    iput-object v0, p0, Lcom/facebook/react/devsupport/DevServerHelper;->mPackageName:Ljava/lang/String;
...
.method private createBundleURL(Ljava/lang/String;Lcom/facebook/react/devsupport/DevServerHelper$BundleType;Ljava/lang/String;ZZ)Ljava/lang/String;
    ...
    .param p2, "type"    # Lcom/facebook/react/devsupport/DevServerHelper$BundleType;
    .param p3, "host"    # Ljava/lang/String;
    .param p4, "modulesOnly"    # Z
    .param p5, "runModule"    # Z
    ...
    .line 390
    .local v2, "additionalOptionsBuilder":Ljava/lang/StringBuilder;
    ...
    .line 396
    const-string v6, "http://%s/%s.%s?platform=android&dev=%s&lazy=%s&minify=%s&app=%s&modulesOnly=%s&runModule=%s"
    ...
    const-string v4, "&excludeSource=true&sourcePaths=url-server"
...
.method private getInspectorDeviceId()Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/facebook/react/devsupport/DevServerHelper;->getSHA256(Ljava/lang/String;)Ljava/lang/String;
...
.method private static getSHA256(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 269
    const-string v4, "%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x"
    ...
    const-string v4, "This environment doesn\'t support UTF-8 encoding"
    ...
    const-string v4, "Could not get standard SHA-256 algorithm"
...
.method public downloadBundleResourceFromUrlSync(Ljava/lang/String;Ljava/io/File;)Ljava/io/File;
    ...
    .line 497
    .restart local v4    # "output":Lokio/Sink;
    :catchall_0
    move-exception v5
...
.method public isPackagerRunning(Lcom/facebook/react/devsupport/interfaces/PackagerStatusCallback;)V
    ...
    const-string v2, "No packager host configured."
    ...
    invoke-interface {p1, v1}, Lcom/facebook/react/devsupport/interfaces/PackagerStatusCallback;->onPackagerStatusFetched(Z)V
...
.method public launchJSDevtools()V
    ...
    invoke-direct {v2, p0}, Lcom/facebook/react/devsupport/DevServerHelper$5;-><init>(Lcom/facebook/react/devsupport/DevServerHelper;)V
...
.method public openDebugger(Lcom/facebook/react/bridge/ReactContext;Ljava/lang/String;)V
    ...
    invoke-direct {v3, p0, p1, p2}, Lcom/facebook/react/devsupport/DevServerHelper$6;-><init>(Lcom/facebook/react/devsupport/DevServerHelper;Lcom/facebook/react/bridge/ReactContext;Ljava/lang/String;)V
