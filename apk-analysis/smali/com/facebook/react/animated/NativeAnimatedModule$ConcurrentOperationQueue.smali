...
.method private drainQueueIntoList(J)Ljava/util/List;
    ...
    .line 190
    .local v0, "operations":Ljava/util/List;, "Ljava/util/List<Lcom/facebook/react/animated/NativeAnimatedModule$UIThreadOperation;>;"
    :goto_0
    ...
    .line 199
    .local v2, "polledOperation":Lcom/facebook/react/animated/NativeAnimatedModule$UIThreadOperation;
    if-nez v2, :cond_3
    ...
    .line 213
    .end local v2    # "polledOperation":Lcom/facebook/react/animated/NativeAnimatedModule$UIThreadOperation;
    :goto_1
    return-object v0

    .line 210
    .restart local v2    # "polledOperation":Lcom/facebook/react/animated/NativeAnimatedModule$UIThreadOperation;
    :cond_4
    invoke-interface {v0, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z
...
.method executeBatch(JLcom/facebook/react/animated/NativeAnimatedNodesManager;)V
    .locals 3
    .param p1, "maxBatchNumber"    # J
    .param p3, "nodesManager"    # Lcom/facebook/react/animated/NativeAnimatedNodesManager;
    ...
    invoke-virtual {v2, p3}, Lcom/facebook/react/animated/NativeAnimatedModule$UIThreadOperation;->execute(Lcom/facebook/react/animated/NativeAnimatedNodesManager;)V
