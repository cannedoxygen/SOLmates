...
.method public static final load(ZZZ)V
    .locals 4
    .param p0, "turboModulesEnabled"    # Z
    .param p1, "fabricEnabled"    # Z
    .param p2, "bridgelessEnabled"    # Z
    .annotation runtime Lkotlin/jvm/JvmStatic;
    .end annotation
    ...
    .line 47
    new-instance v2, Lcom/facebook/react/defaults/DefaultNewArchitectureEntryPoint$load$1;

    invoke-direct {v2, p1}, Lcom/facebook/react/defaults/DefaultNewArchitectureEntryPoint$load$1;-><init>(Z)V

    check-cast v2, Lcom/facebook/react/internal/featureflags/ReactNativeFeatureFlagsProvider;

    .line 46
    invoke-static {v2}, Lcom/facebook/react/internal/featureflags/ReactNativeFeatureFlags;->override(Lcom/facebook/react/internal/featureflags/ReactNativeFeatureFlagsProvider;)V
    ...
    .line 62
    sget-object v2, Lcom/facebook/react/defaults/DefaultSoLoader;->Companion:Lcom/facebook/react/defaults/DefaultSoLoader$Companion;

    invoke-virtual {v2}, Lcom/facebook/react/defaults/DefaultSoLoader$Companion;->maybeLoadSoLibrary()V
...
.method public final isConfigurationValid(ZZZ)Lkotlin/Pair;
    .locals 2
    .param p1, "turboModulesEnabled"    # Z
    .param p2, "fabricEnabled"    # Z
    .param p3, "bridgelessEnabled"    # Z
    ...
    .line 97
    const-string v1, "fabricEnabled=true requires turboModulesEnabled=true (is now false) - Please update your DefaultNewArchitectureEntryPoint.load() parameters."
    ...
    .line 100
    const-string v1, "bridgelessEnabled=true requires (turboModulesEnabled=true AND fabricEnabled=true) - Please update your DefaultNewArchitectureEntryPoint.load() parameters."
