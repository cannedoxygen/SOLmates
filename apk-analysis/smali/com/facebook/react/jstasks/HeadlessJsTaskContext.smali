...
.method private declared-synchronized startTask(Lcom/facebook/react/jstasks/HeadlessJsTaskConfig;I)V
    ...
    invoke-interface {v1, p2, v2, v3}, Lcom/facebook/react/modules/appregistry/AppRegistry;->startHeadlessTask(ILjava/lang/String;Lcom/facebook/react/bridge/WritableMap;)V

    goto :goto_1

    .line 119
    :cond_2
    const-string v1, "HeadlessJsTaskContext"

    new-instance v2, Ljava/lang/RuntimeException;

    const-string v3, "Cannot start headless task, CatalystInstance not available"
    ...
    invoke-direct {p0, p2, v1, v2}, Lcom/facebook/react/jstasks/HeadlessJsTaskContext;->scheduleTaskTimeout(IJ)V

    .line 126
    :cond_3
    iget-object v1, p0, Lcom/facebook/react/jstasks/HeadlessJsTaskContext;->mHeadlessJsTaskEventListeners:Ljava/util/Set;
    ...
    check-cast v2, Lcom/facebook/react/jstasks/HeadlessJsTaskEventListener;

    .line 127
    .local v2, "listener":Lcom/facebook/react/jstasks/HeadlessJsTaskEventListener;
    invoke-interface {v2, p2}, Lcom/facebook/react/jstasks/HeadlessJsTaskEventListener;->onHeadlessJsTaskStart(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 128
    .end local v2    # "listener":Lcom/facebook/react/jstasks/HeadlessJsTaskEventListener;
    goto :goto_2
...
.method public declared-synchronized addTaskEventListener(Lcom/facebook/react/jstasks/HeadlessJsTaskEventListener;)V
    ...
    .line 69
    .local v1, "activeTaskId":Ljava/lang/Integer;
    invoke-virtual {v1}, Ljava/lang/Integer;->intValue()I

    move-result v2

    invoke-interface {p1, v2}, Lcom/facebook/react/jstasks/HeadlessJsTaskEventListener;->onHeadlessJsTaskStart(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 70
    .end local v1    # "activeTaskId":Ljava/lang/Integer;
    goto :goto_0
    ...
    .line 66
    .end local p1    # "listener":Lcom/facebook/react/jstasks/HeadlessJsTaskEventListener;
    :catchall_0
    move-exception p1
...
.method public declared-synchronized finishTask(I)V
    ...
    .line 181
    new-instance v1, Lcom/facebook/react/jstasks/HeadlessJsTaskContext$2;

    invoke-direct {v1, p0, p1}, Lcom/facebook/react/jstasks/HeadlessJsTaskContext$2;-><init>(Lcom/facebook/react/jstasks/HeadlessJsTaskContext;I)V
...
.method public declared-synchronized retryTask(I)Z
    ...
    .line 140
    .local v0, "sourceTaskConfig":Lcom/facebook/react/jstasks/HeadlessJsTaskConfig;
    const/4 v1, 0x1
    ...
    .line 145
    .local v3, "retryPolicy":Lcom/facebook/react/jstasks/HeadlessJsTaskRetryPolicy;
    ...
    .line 158
    .local v2, "taskConfig":Lcom/facebook/react/jstasks/HeadlessJsTaskConfig;
    new-instance v4, Lcom/facebook/react/jstasks/HeadlessJsTaskContext$1;

    invoke-direct {v4, p0, v2, p1}, Lcom/facebook/react/jstasks/HeadlessJsTaskContext$1;-><init>(Lcom/facebook/react/jstasks/HeadlessJsTaskContext;Lcom/facebook/react/jstasks/HeadlessJsTaskConfig;I)V

    .line 166
    .local v4, "retryAttempt":Ljava/lang/Runnable;
    ...
    invoke-static {v4, v5, v6}, Lcom/facebook/react/bridge/UiThreadUtil;->runOnUiThread(Ljava/lang/Runnable;J)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 138
    .end local v0    # "sourceTaskConfig":Lcom/facebook/react/jstasks/HeadlessJsTaskConfig;
    .end local v2    # "taskConfig":Lcom/facebook/react/jstasks/HeadlessJsTaskConfig;
    .end local v3    # "retryPolicy":Lcom/facebook/react/jstasks/HeadlessJsTaskRetryPolicy;
    .end local v4    # "retryAttempt":Ljava/lang/Runnable;
    .end local p0    # "this":Lcom/facebook/react/jstasks/HeadlessJsTaskContext;
    .end local p1    # "taskId":I
    :catchall_0
    move-exception p1
