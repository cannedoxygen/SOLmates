...
.method constructor <init>(Landroid/content/Context;Landroid/app/Activity;Lcom/facebook/react/modules/core/DefaultHardwareBackBtnHandler;Lcom/facebook/react/bridge/JavaScriptExecutorFactory;Lcom/facebook/react/bridge/JSBundleLoader;Ljava/lang/String;Ljava/util/List;ZLcom/facebook/react/devsupport/DevSupportManagerFactory;ZZLcom/facebook/react/bridge/NotThreadSafeBridgeIdleDebugListener;Lcom/facebook/react/common/LifecycleState;Lcom/facebook/react/bridge/JSExceptionHandler;Lcom/facebook/react/devsupport/interfaces/RedBoxHandler;ZLcom/facebook/react/devsupport/interfaces/DevBundleDownloadListener;IILcom/facebook/react/bridge/UIManagerProvider;Ljava/util/Map;Lcom/facebook/react/ReactPackageTurboModuleManagerDelegate$Builder;Lcom/facebook/react/common/SurfaceDelegateFactory;Lcom/facebook/react/devsupport/interfaces/DevLoadingViewManager;Lcom/facebook/react/internal/ChoreographerProvider;Lcom/facebook/react/devsupport/interfaces/PausedInDebuggerOverlayManager;)V
    ...
    .param p9, "devSupportManagerFactory"    # Lcom/facebook/react/devsupport/DevSupportManagerFactory;
    .param p10, "requireActivity"    # Z
    .param p11, "keepActivity"    # Z
    .param p12, "bridgeIdleDebugListener"    # Lcom/facebook/react/bridge/NotThreadSafeBridgeIdleDebugListener;
    .param p13, "initialLifecycleState"    # Lcom/facebook/react/common/LifecycleState;
    .param p14, "jSExceptionHandler"    # Lcom/facebook/react/bridge/JSExceptionHandler;
    .param p15, "redBoxHandler"    # Lcom/facebook/react/devsupport/interfaces/RedBoxHandler;
    .param p16, "lazyViewManagersEnabled"    # Z
    .param p17, "devBundleDownloadListener"    # Lcom/facebook/react/devsupport/interfaces/DevBundleDownloadListener;
    .param p18, "minNumShakes"    # I
    .param p19, "minTimeLeftInFrameForNonBatchedOperationMs"    # I
    .param p20, "uIManagerProvider"    # Lcom/facebook/react/bridge/UIManagerProvider;
    .param p22, "tmmDelegateBuilder"    # Lcom/facebook/react/ReactPackageTurboModuleManagerDelegate$Builder;
    .param p23, "surfaceDelegateFactory"    # Lcom/facebook/react/common/SurfaceDelegateFactory;
    .param p24, "devLoadingViewManager"    # Lcom/facebook/react/devsupport/interfaces/DevLoadingViewManager;
    .param p25, "choreographerProvider"    # Lcom/facebook/react/internal/ChoreographerProvider;
    .param p26, "pausedInDebuggerOverlayManager"    # Lcom/facebook/react/devsupport/interfaces/PausedInDebuggerOverlayManager;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .local p21, "customPackagerCommandHandlers":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Lcom/facebook/react/packagerconnection/RequestHandler;>;"
    ...
    .line 262
    iput-object v14, v1, Lcom/facebook/react/ReactInstanceManager;->mApplicationContext:Landroid/content/Context;

    .line 263
    move-object/from16 v15, p2

    iput-object v15, v1, Lcom/facebook/react/ReactInstanceManager;->mCurrentActivity:Landroid/app/Activity;

    .line 264
    move-object/from16 v13, p3

    iput-object v13, v1, Lcom/facebook/react/ReactInstanceManager;->mDefaultBackButtonImpl:Lcom/facebook/react/modules/core/DefaultHardwareBackBtnHandler;

    .line 265
    move-object/from16 v12, p4

    iput-object v12, v1, Lcom/facebook/react/ReactInstanceManager;->mJavaScriptExecutorFactory:Lcom/facebook/react/bridge/JavaScriptExecutorFactory;

    .line 266
    move-object/from16 v11, p5

    iput-object v11, v1, Lcom/facebook/react/ReactInstanceManager;->mBundleLoader:Lcom/facebook/react/bridge/JSBundleLoader;

    .line 267
    move-object/from16 v10, p6

    iput-object v10, v1, Lcom/facebook/react/ReactInstanceManager;->mJSMainModulePath:Ljava/lang/String;
    ...
    iput-object v0, v1, Lcom/facebook/react/ReactInstanceManager;->mPackages:Ljava/util/List;

    .line 269
    move/from16 v9, p8

    iput-boolean v9, v1, Lcom/facebook/react/ReactInstanceManager;->mUseDeveloperSupport:Z

    .line 270
    move/from16 v8, p10

    iput-boolean v8, v1, Lcom/facebook/react/ReactInstanceManager;->mRequireActivity:Z

    .line 271
    move/from16 v7, p11

    iput-boolean v7, v1, Lcom/facebook/react/ReactInstanceManager;->mKeepActivity:Z
    ...
    iget-object v0, v1, Lcom/facebook/react/ReactInstanceManager;->mJSMainModulePath:Ljava/lang/String;
    ...
    invoke-direct {v0, v14}, Lcom/facebook/react/MemoryPressureRouter;-><init>(Landroid/content/Context;)V

    iput-object v0, v1, Lcom/facebook/react/ReactInstanceManager;->mMemoryPressureRouter:Lcom/facebook/react/MemoryPressureRouter;

    .line 291
    move-object/from16 v4, p14

    iput-object v4, v1, Lcom/facebook/react/ReactInstanceManager;->mJSExceptionHandler:Lcom/facebook/react/bridge/JSExceptionHandler;

    .line 292
    move-object/from16 v5, p22

    iput-object v5, v1, Lcom/facebook/react/ReactInstanceManager;->mTMMDelegateBuilder:Lcom/facebook/react/ReactPackageTurboModuleManagerDelegate$Builder;

    .line 293
    iget-object v6, v1, Lcom/facebook/react/ReactInstanceManager;->mPackages:Ljava/util/List;
    ...
    sget-object v7, Lcom/facebook/debug/tags/ReactDebugOverlayTags;->RN_CORE:Lcom/facebook/debug/debugoverlay/model/DebugOverlayTag;

    const-string v8, "RNCore: Use Split Packages"

    .line 295
    invoke-interface {v0, v7, v8}, Lcom/facebook/debug/holder/Printer;->logMessage(Lcom/facebook/debug/debugoverlay/model/DebugOverlayTag;Ljava/lang/String;)V

    .line 296
    iget-object v0, v1, Lcom/facebook/react/ReactInstanceManager;->mPackages:Ljava/util/List;

    new-instance v7, Lcom/facebook/react/CoreModulesPackage;

    new-instance v8, Lcom/facebook/react/ReactInstanceManager$1;

    invoke-direct {v8, v1}, Lcom/facebook/react/ReactInstanceManager$1;-><init>(Lcom/facebook/react/ReactInstanceManager;)V
    :try_end_0
    ...
    :try_start_1
    invoke-direct {v7, v1, v8, v9, v10}, Lcom/facebook/react/CoreModulesPackage;-><init>(Lcom/facebook/react/ReactInstanceManager;Lcom/facebook/react/modules/core/DefaultHardwareBackBtnHandler;ZI)V
    ...
    new-instance v7, Lcom/facebook/react/DebugCorePackage;

    invoke-direct {v7}, Lcom/facebook/react/DebugCorePackage;-><init>()V
    ...
    iput-object v8, v1, Lcom/facebook/react/ReactInstanceManager;->mUIManagerProvider:Lcom/facebook/react/bridge/UIManagerProvider;
...
.method private attachRootViewToInstance(Lcom/facebook/react/uimanager/ReactRoot;)V
    .locals 11
    .param p1, "reactRoot"    # Lcom/facebook/react/uimanager/ReactRoot;
    ...
    .line 1332
    .local v1, "initialProperties":Landroid/os/Bundle;
    invoke-interface {p1}, Lcom/facebook/react/uimanager/ReactRoot;->getUIManagerType()I
    ...
    .line 1345
    :goto_1
    invoke-interface {v0, v2, v5}, Lcom/facebook/react/bridge/UIManager;->addRootView(Landroid/view/View;Lcom/facebook/react/bridge/WritableMap;)I

    move-result v5

    .line 1350
    .restart local v5    # "rootTag":I
    invoke-interface {p1, v5}, Lcom/facebook/react/uimanager/ReactRoot;->setRootViewTag(I)V
    ...
    invoke-static {v3, v4, v2, v5}, Lcom/facebook/systrace/Systrace;->beginAsyncSection(JLjava/lang/String;I)V

    .line 1356
    new-instance v2, Lcom/facebook/react/ReactInstanceManager$$ExternalSyntheticLambda0;

    invoke-direct {v2, v5, p1}, Lcom/facebook/react/ReactInstanceManager$$ExternalSyntheticLambda0;-><init>(ILcom/facebook/react/uimanager/ReactRoot;)V
    ...
    .line 1324
    .end local v1    # "initialProperties":Landroid/os/Bundle;
    .end local v5    # "rootTag":I
    :cond_4
    new-instance v1, Ljava/lang/IllegalStateException;

    const-string v2, "Unable to attach a rootView to ReactInstance when UIManager is not properly initialized."
...
.method private createReactContext(Lcom/facebook/react/bridge/JavaScriptExecutor;Lcom/facebook/react/bridge/JSBundleLoader;)Lcom/facebook/react/bridge/ReactApplicationContext;
    ...
    .line 1439
    .local v0, "reactContext":Lcom/facebook/react/bridge/BridgeReactContext;
    ...
    .line 1440
    .local v1, "exceptionHandler":Lcom/facebook/react/bridge/JSExceptionHandler;
    :goto_0
    ...
    .line 1450
    invoke-virtual {v3, v1}, Lcom/facebook/react/bridge/CatalystInstanceImpl$Builder;->setJSExceptionHandler(Lcom/facebook/react/bridge/JSExceptionHandler;)Lcom/facebook/react/bridge/CatalystInstanceImpl$Builder;
    ...
    invoke-virtual {v3, v4}, Lcom/facebook/react/bridge/CatalystInstanceImpl$Builder;->setInspectorTarget(Lcom/facebook/react/bridge/ReactInstanceManagerInspectorTarget;)Lcom/facebook/react/bridge/CatalystInstanceImpl$Builder;
    ...
    .line 1455
    const-string v4, "createCatalystInstance"

    const-wide/16 v5, 0x0

    invoke-static {v5, v6, v4}, Lcom/facebook/systrace/Systrace;->beginSection(JLjava/lang/String;)V
    ...
    .line 1460
    .local v4, "catalystInstance":Lcom/facebook/react/bridge/CatalystInstance;
    ...
    .line 1464
    invoke-virtual {v0, v4}, Lcom/facebook/react/bridge/BridgeReactContext;->initializeWithInstance(Lcom/facebook/react/bridge/CatalystInstance;)V

    .line 1471
    invoke-interface {v4}, Lcom/facebook/react/bridge/CatalystInstance;->getRuntimeScheduler()Lcom/facebook/react/bridge/RuntimeScheduler;

    .line 1473
    sget-boolean v7, Lcom/facebook/react/config/ReactFeatureFlags;->useTurboModules:Z

    if-eqz v7, :cond_1

    iget-object v7, p0, Lcom/facebook/react/ReactInstanceManager;->mTMMDelegateBuilder:Lcom/facebook/react/ReactPackageTurboModuleManagerDelegate$Builder;
    ...
    .line 1476
    invoke-virtual {v7, v8}, Lcom/facebook/react/ReactPackageTurboModuleManagerDelegate$Builder;->setPackages(Ljava/util/List;)Lcom/facebook/react/ReactPackageTurboModuleManagerDelegate$Builder;

    move-result-object v7

    .line 1477
    invoke-virtual {v7, v0}, Lcom/facebook/react/ReactPackageTurboModuleManagerDelegate$Builder;->setReactApplicationContext(Lcom/facebook/react/bridge/ReactApplicationContext;)Lcom/facebook/react/ReactPackageTurboModuleManagerDelegate$Builder;

    move-result-object v7

    .line 1478
    invoke-virtual {v7}, Lcom/facebook/react/ReactPackageTurboModuleManagerDelegate$Builder;->build()Lcom/facebook/react/ReactPackageTurboModuleManagerDelegate;

    move-result-object v7

    .line 1480
    .local v7, "tmmDelegate":Lcom/facebook/react/internal/turbomodule/core/TurboModuleManagerDelegate;
    new-instance v8, Lcom/facebook/react/internal/turbomodule/core/TurboModuleManager;
    ...
    .line 1484
    invoke-interface {v4}, Lcom/facebook/react/bridge/CatalystInstance;->getJSCallInvokerHolder()Lcom/facebook/react/turbomodule/core/interfaces/CallInvokerHolder;

    move-result-object v10

    .line 1485
    invoke-interface {v4}, Lcom/facebook/react/bridge/CatalystInstance;->getNativeMethodCallInvokerHolder()Lcom/facebook/react/turbomodule/core/interfaces/NativeMethodCallInvokerHolder;

    move-result-object v11

    invoke-direct {v8, v9, v7, v10, v11}, Lcom/facebook/react/internal/turbomodule/core/TurboModuleManager;-><init>(Lcom/facebook/react/bridge/RuntimeExecutor;Lcom/facebook/react/internal/turbomodule/core/TurboModuleManagerDelegate;Lcom/facebook/react/turbomodule/core/interfaces/CallInvokerHolder;Lcom/facebook/react/turbomodule/core/interfaces/NativeMethodCallInvokerHolder;)V

    .line 1487
    .local v8, "turboModuleManager":Lcom/facebook/react/internal/turbomodule/core/TurboModuleManager;
    invoke-interface {v4, v8}, Lcom/facebook/react/bridge/CatalystInstance;->setTurboModuleRegistry(Lcom/facebook/react/internal/turbomodule/core/interfaces/TurboModuleRegistry;)V

    .line 1490
    invoke-virtual {v8}, Lcom/facebook/react/internal/turbomodule/core/TurboModuleManager;->getEagerInitModuleNames()Ljava/util/List;
    ...
    .line 1491
    .local v10, "moduleName":Ljava/lang/String;
    invoke-virtual {v8, v10}, Lcom/facebook/react/internal/turbomodule/core/TurboModuleManager;->getModule(Ljava/lang/String;)Lcom/facebook/react/bridge/NativeModule;

    .line 1492
    .end local v10    # "moduleName":Ljava/lang/String;
    goto :goto_1

    .line 1495
    .end local v7    # "tmmDelegate":Lcom/facebook/react/internal/turbomodule/core/TurboModuleManagerDelegate;
    .end local v8    # "turboModuleManager":Lcom/facebook/react/internal/turbomodule/core/TurboModuleManager;
    :cond_1
    iget-object v7, p0, Lcom/facebook/react/ReactInstanceManager;->mUIManagerProvider:Lcom/facebook/react/bridge/UIManagerProvider;
    ...
    invoke-interface {v7, v0}, Lcom/facebook/react/bridge/UIManagerProvider;->createUIManager(Lcom/facebook/react/bridge/ReactApplicationContext;)Lcom/facebook/react/bridge/UIManager;

    move-result-object v7

    .line 1497
    .local v7, "uiManager":Lcom/facebook/react/bridge/UIManager;
    if-eqz v7, :cond_2

    .line 1498
    invoke-interface {v4, v7}, Lcom/facebook/react/bridge/CatalystInstance;->setFabricUIManager(Lcom/facebook/react/bridge/UIManager;)V

    .line 1501
    invoke-interface {v7}, Lcom/facebook/react/bridge/UIManager;->initialize()V

    .line 1502
    invoke-interface {v4, v7}, Lcom/facebook/react/bridge/CatalystInstance;->setFabricUIManager(Lcom/facebook/react/bridge/UIManager;)V

    .line 1505
    .end local v7    # "uiManager":Lcom/facebook/react/bridge/UIManager;
    :cond_2
    ...
    invoke-interface {v4, v7}, Lcom/facebook/react/bridge/CatalystInstance;->addBridgeIdleDebugListener(Lcom/facebook/react/bridge/NotThreadSafeBridgeIdleDebugListener;)V

    .line 1508
    :cond_3
    invoke-static {v5, v6}, Lcom/facebook/systrace/Systrace;->isTracing(J)Z
    ...
    invoke-interface {v4, v7, v8}, Lcom/facebook/react/bridge/CatalystInstance;->setGlobalVariable(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 1513
    const-string/jumbo v7, "runJSBundle"

    invoke-static {v5, v6, v7}, Lcom/facebook/systrace/Systrace;->beginSection(JLjava/lang/String;)V

    .line 1514
    invoke-interface {v4}, Lcom/facebook/react/bridge/CatalystInstance;->runJSBundle()V
    ...
    .line 1460
    .end local v4    # "catalystInstance":Lcom/facebook/react/bridge/CatalystInstance;
    :catchall_0
    move-exception v4
...
.method private detachRootViewFromInstance(Lcom/facebook/react/uimanager/ReactRoot;Lcom/facebook/react/bridge/ReactContext;)V
    ...
    .line 1385
    .local v3, "uiManager":Lcom/facebook/react/bridge/UIManager;
    if-eqz v3, :cond_1

    .line 1386
    invoke-interface {v3, v2}, Lcom/facebook/react/bridge/UIManager;->stopSurface(I)V

    goto :goto_0

    .line 1388
    :cond_1
    const-string v4, "Failed to stop surface, UIManager has already gone away"

    invoke-static {v1, v4}, Lcom/facebook/common/logging/FLog;->w(Ljava/lang/String;Ljava/lang/String;)V

    .line 1390
    .end local v3    # "uiManager":Lcom/facebook/react/bridge/UIManager;
    :goto_0
    goto :goto_1
    ...
    const-string v4, "detachRootViewFromInstance called with ReactRootView with invalid id"
    ...
    invoke-interface {v1, v2}, Lcom/facebook/react/modules/appregistry/AppRegistry;->unmountApplicationComponentAtRootTag(I)V
...
.method static synthetic lambda$attachRootViewToInstance$6(ILcom/facebook/react/uimanager/ReactRoot;)V
    ...
    invoke-interface {p1, v0}, Lcom/facebook/react/uimanager/ReactRoot;->onStage(I)V
...
.method private synthetic lambda$runCreateReactContextOnNewThread$2(Lcom/facebook/react/ReactInstanceManager$ReactContextInitParams;)V
    ...
    .line 1210
    invoke-direct {p0, v0, v2}, Lcom/facebook/react/ReactInstanceManager;->createReactContext(Lcom/facebook/react/bridge/JavaScriptExecutor;Lcom/facebook/react/bridge/JSBundleLoader;)Lcom/facebook/react/bridge/ReactApplicationContext;
    ...
    .line 1222
    new-instance v1, Lcom/facebook/react/ReactInstanceManager$$ExternalSyntheticLambda2;

    invoke-direct {v1, p0}, Lcom/facebook/react/ReactInstanceManager$$ExternalSyntheticLambda2;-><init>(Lcom/facebook/react/ReactInstanceManager;)V

    .line 1229
    .local v1, "maybeRecreateReactContextRunnable":Ljava/lang/Runnable;
    new-instance v2, Lcom/facebook/react/ReactInstanceManager$$ExternalSyntheticLambda3;

    invoke-direct {v2, p0, v0}, Lcom/facebook/react/ReactInstanceManager$$ExternalSyntheticLambda3;-><init>(Lcom/facebook/react/ReactInstanceManager;Lcom/facebook/react/bridge/ReactApplicationContext;)V
    ...
    invoke-interface {v2, v1}, Lcom/facebook/react/devsupport/interfaces/DevSupportManager;->handleException(Ljava/lang/Exception;)V
...
.method private synthetic lambda$setupReactContext$3([Lcom/facebook/react/ReactInstanceEventListener;Lcom/facebook/react/bridge/ReactApplicationContext;)V
    .locals 3
    .param p1, "finalListeners"    # [Lcom/facebook/react/ReactInstanceEventListener;
    ...
    .line 1290
    .local v2, "listener":Lcom/facebook/react/ReactInstanceEventListener;
    if-eqz v2, :cond_0
    ...
    .line 1285
    .end local v2    # "listener":Lcom/facebook/react/ReactInstanceEventListener;
    :cond_0
...
.method private processPackage(Lcom/facebook/react/ReactPackage;Lcom/facebook/react/NativeModuleRegistryBuilder;)V
    ...
    invoke-interface {v0}, Lcom/facebook/react/ReactPackageLogger;->endProcessPackage()V
...
.method private registerCxxErrorHandlerFunc()V
    ...
    .line 405
    .local v1, "handleCxxErrorFunc":Ljava/lang/reflect/Method;
    :try_start_0
    const-class v2, Lcom/facebook/react/ReactInstanceManager;

    const-string v3, "handleCxxError"
    ...
    const-string v3, "ReactInstanceHolder"

    const-string v4, "Failed to set cxx error handler function"
    ...
    :goto_0
    invoke-static {p0, v1}, Lcom/facebook/react/bridge/ReactCxxErrorHandler;->setHandleErrorFunc(Ljava/lang/Object;Ljava/lang/reflect/Method;)V
...
.method private setupReactContext(Lcom/facebook/react/bridge/ReactApplicationContext;)V
    ...
    .line 1269
    .local v5, "reactRoot":Lcom/facebook/react/uimanager/ReactRoot;
    invoke-direct {p0, v5}, Lcom/facebook/react/ReactInstanceManager;->attachRootViewToInstance(Lcom/facebook/react/uimanager/ReactRoot;)V

    .line 1270
    .end local v5    # "reactRoot":Lcom/facebook/react/uimanager/ReactRoot;
    goto :goto_0
    ...
    .line 1278
    .local v0, "listeners":[Lcom/facebook/react/ReactInstanceEventListener;
    ...
    .line 1281
    .local v3, "finalListeners":[Lcom/facebook/react/ReactInstanceEventListener;
    new-instance v4, Lcom/facebook/react/ReactInstanceManager$$ExternalSyntheticLambda4;

    invoke-direct {v4, p0, v3, p1}, Lcom/facebook/react/ReactInstanceManager$$ExternalSyntheticLambda4;-><init>(Lcom/facebook/react/ReactInstanceManager;[Lcom/facebook/react/ReactInstanceEventListener;Lcom/facebook/react/bridge/ReactApplicationContext;)V

    invoke-static {v4}, Lcom/facebook/react/bridge/UiThreadUtil;->runOnUiThread(Ljava/lang/Runnable;)Z

    .line 1295
    new-instance v4, Lcom/facebook/react/ReactInstanceManager$$ExternalSyntheticLambda5;

    invoke-direct {v4}, Lcom/facebook/react/ReactInstanceManager$$ExternalSyntheticLambda5;-><init>()V

    invoke-virtual {p1, v4}, Lcom/facebook/react/bridge/ReactApplicationContext;->runOnJSQueueThread(Ljava/lang/Runnable;)Z

    .line 1300
    new-instance v4, Lcom/facebook/react/ReactInstanceManager$$ExternalSyntheticLambda6;

    invoke-direct {v4}, Lcom/facebook/react/ReactInstanceManager$$ExternalSyntheticLambda6;-><init>()V
    ...
    .line 1257
    .end local v0    # "listeners":[Lcom/facebook/react/ReactInstanceEventListener;
    .end local v3    # "finalListeners":[Lcom/facebook/react/ReactInstanceEventListener;
    :catchall_0
    move-exception v1
...
.method private tearDownReactContext(Lcom/facebook/react/bridge/ReactContext;)V
    ...
    .line 1416
    .local v2, "reactRoot":Lcom/facebook/react/uimanager/ReactRoot;
    ...
    .line 1417
    .end local v2    # "reactRoot":Lcom/facebook/react/uimanager/ReactRoot;
    goto :goto_0
...
.method private toggleElementInspector()V
    ...
    const-string v3, "Cannot toggleElementInspector, CatalystInstance not available"
...
.method public getOrCreateViewManagers(Lcom/facebook/react/bridge/ReactApplicationContext;)Ljava/util/List;
    ...
    .line 996
    .local v3, "viewManagers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/facebook/react/uimanager/ViewManager;>;"
    ...
    .line 997
    .local v5, "reactPackage":Lcom/facebook/react/ReactPackage;
    ...
    .end local v5    # "reactPackage":Lcom/facebook/react/ReactPackage;
    goto :goto_0
    ...
    .line 1002
    .end local v3    # "viewManagers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/facebook/react/uimanager/ViewManager;>;"
    :cond_1
    :try_start_2
    monitor-exit v0
...
.method public getViewManagerNames()Ljava/util/Collection;
    ...
    .line 1045
    .local v4, "context":Lcom/facebook/react/bridge/ReactApplicationContext;
    if-eqz v4, :cond_6

    invoke-virtual {v4}, Lcom/facebook/react/bridge/ReactApplicationContext;->hasActiveReactInstance()Z
    ...
    .line 1052
    :try_start_4
    iget-object v5, p0, Lcom/facebook/react/ReactInstanceManager;->mViewManagerNames:Ljava/util/Collection;
    ...
    .line 1054
    .local v5, "uniqueNames":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    ...
    .line 1055
    .local v7, "reactPackage":Lcom/facebook/react/ReactPackage;
    ...
    check-cast v8, Lcom/facebook/react/ViewManagerOnDemandReactPackage;

    .line 1061
    invoke-interface {v8, v4}, Lcom/facebook/react/ViewManagerOnDemandReactPackage;->getViewManagerNames(Lcom/facebook/react/bridge/ReactApplicationContext;)Ljava/util/Collection;

    move-result-object v8

    .line 1062
    .local v8, "names":Ljava/util/Collection;, "Ljava/util/Collection<Ljava/lang/String;>;"
    if-eqz v8, :cond_2
    ...
    .line 1065
    .end local v8    # "names":Ljava/util/Collection;, "Ljava/util/Collection<Ljava/lang/String;>;"
    :cond_2
    goto :goto_1
    ...
    const-string v9, "Package %s is not a ViewManagerOnDemandReactPackage, view managers will not be loaded"
    ...
    .line 1073
    .end local v7    # "reactPackage":Lcom/facebook/react/ReactPackage;
    goto :goto_0

    .line 1074
    :cond_4
    iput-object v5, p0, Lcom/facebook/react/ReactInstanceManager;->mViewManagerNames:Ljava/util/Collection;

    .line 1076
    .end local v5    # "uniqueNames":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    :cond_5
    iget-object v5, p0, Lcom/facebook/react/ReactInstanceManager;->mViewManagerNames:Ljava/util/Collection;
    ...
    const-string v6, "Calling getViewManagerNames without active context"
    ...
    .line 1049
    .end local v4    # "context":Lcom/facebook/react/bridge/ReactApplicationContext;
    :catchall_1
    move-exception v4
    ...
    .line 1079
    .end local v0    # "viewManagerNames":Ljava/util/Collection;, "Ljava/util/Collection<Ljava/lang/String;>;"
    :catchall_2
    move-exception v0
...
.method public onHostResume(Landroid/app/Activity;)V
    ...
    invoke-interface {v2, v1}, Lcom/facebook/react/devsupport/interfaces/DevSupportManager;->setDevSupportEnabled(Z)V
...
.method public declared-synchronized setUseFallbackBundle(Z)V
    ...
    .line 376
    .end local p0    # "this":Lcom/facebook/react/ReactInstanceManager;
    .end local p1    # "useFallbackBundle":Z
    :catchall_0
    move-exception p1
