...
.method private onFabricCommitEnd(Lcom/facebook/react/fabric/DevToolsReactPerfLogger$FabricCommitPoint;)V
    .locals 2
    .param p1, "commitPoint"    # Lcom/facebook/react/fabric/DevToolsReactPerfLogger$FabricCommitPoint;
    ...
    .line 221
    .local v1, "listener":Lcom/facebook/react/fabric/DevToolsReactPerfLogger$DevToolsReactPerfLoggerListener;
    ...
    .line 222
    .end local v1    # "listener":Lcom/facebook/react/fabric/DevToolsReactPerfLogger$DevToolsReactPerfLoggerListener;
    goto :goto_0
...
.method public addDevToolsReactPerfLoggerListener(Lcom/facebook/react/fabric/DevToolsReactPerfLogger$DevToolsReactPerfLoggerListener;)V
    .locals 1
    .param p1, "listener"    # Lcom/facebook/react/fabric/DevToolsReactPerfLogger$DevToolsReactPerfLoggerListener;
...
.method public logFabricMarker(Lcom/facebook/react/bridge/ReactMarkerConstants;Ljava/lang/String;IJ)V
    .locals 7
    .param p1, "name"    # Lcom/facebook/react/bridge/ReactMarkerConstants;
    .param p2, "tag"    # Ljava/lang/String;
    .param p3, "instanceKey"    # I
...
.method public logFabricMarker(Lcom/facebook/react/bridge/ReactMarkerConstants;Ljava/lang/String;IJI)V
    ...
    check-cast v0, Lcom/facebook/react/fabric/DevToolsReactPerfLogger$FabricCommitPoint;

    .line 206
    .local v0, "commitPoint":Lcom/facebook/react/fabric/DevToolsReactPerfLogger$FabricCommitPoint;
    if-nez v0, :cond_0

    .line 207
    new-instance v1, Lcom/facebook/react/fabric/DevToolsReactPerfLogger$FabricCommitPoint;

    const/4 v2, 0x0

    invoke-direct {v1, p3, v2}, Lcom/facebook/react/fabric/DevToolsReactPerfLogger$FabricCommitPoint;-><init>(ILcom/facebook/react/fabric/DevToolsReactPerfLogger$FabricCommitPoint-IA;)V

    move-object v0, v1

    .line 208
    iget-object v1, p0, Lcom/facebook/react/fabric/DevToolsReactPerfLogger;->mFabricCommitMarkers:Ljava/util/Map;
    ...
    .line 210
    :cond_0
    new-instance v1, Lcom/facebook/react/fabric/DevToolsReactPerfLogger$FabricCommitPointData;

    invoke-direct {v1, p4, p5, p6}, Lcom/facebook/react/fabric/DevToolsReactPerfLogger$FabricCommitPointData;-><init>(JI)V

    invoke-static {v0, p1, v1}, Lcom/facebook/react/fabric/DevToolsReactPerfLogger$FabricCommitPoint;->-$$Nest$maddPoint(Lcom/facebook/react/fabric/DevToolsReactPerfLogger$FabricCommitPoint;Lcom/facebook/react/bridge/ReactMarkerConstants;Lcom/facebook/react/fabric/DevToolsReactPerfLogger$FabricCommitPointData;)V
    ...
    .line 213
    invoke-direct {p0, v0}, Lcom/facebook/react/fabric/DevToolsReactPerfLogger;->onFabricCommitEnd(Lcom/facebook/react/fabric/DevToolsReactPerfLogger$FabricCommitPoint;)V
    ...
    .line 217
    .end local v0    # "commitPoint":Lcom/facebook/react/fabric/DevToolsReactPerfLogger$FabricCommitPoint;
    :cond_1
    return-void
.end method
