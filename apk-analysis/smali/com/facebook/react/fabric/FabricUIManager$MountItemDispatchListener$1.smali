...
.method constructor <init>(Lcom/facebook/react/fabric/FabricUIManager$MountItemDispatchListener;)V
    .locals 0
    .param p1, "this$1"    # Lcom/facebook/react/fabric/FabricUIManager$MountItemDispatchListener;
...
.method public run()V
    ...
    .line 1281
    .local v0, "surfaceIdsToReportMount":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Integer;>;"
    ...
    .line 1284
    .local v1, "binding":Lcom/facebook/react/fabric/Binding;
    if-eqz v1, :cond_2
    ...
    invoke-interface {v1, v3}, Lcom/facebook/react/fabric/Binding;->reportMount(I)V
