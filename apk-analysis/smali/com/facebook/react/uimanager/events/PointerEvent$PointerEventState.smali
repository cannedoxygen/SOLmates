...
.method public constructor <init>(IIIILjava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Set;)V
    .locals 1
    .param p1, "primaryPointerId"    # I
    .param p2, "activePointerId"    # I
    .param p3, "lastButtonState"    # I
    .param p4, "surfaceId"    # I
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(IIII",
            "Ljava/util/Map<",
    ...
    .line 361
    .local p5, "offsetByPointerId":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/Integer;[F>;"
    .local p6, "hitPathByPointerId":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/Integer;Ljava/util/List<Lcom/facebook/react/uimanager/TouchTargetHelper$ViewTarget;>;>;"
    .local p7, "eventCoordinatesByPointerId":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/Integer;[F>;"
    .local p8, "screenCoordinatesByPointerId":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/Integer;[F>;"
    .local p9, "hoveringPointerIds":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/Integer;>;"
    ...
    invoke-direct {v0, p9}, Ljava/util/HashSet;-><init>(Ljava/util/Collection;)V

    iput-object v0, p0, Lcom/facebook/react/uimanager/events/PointerEvent$PointerEventState;->mHoveringPointerIds:Ljava/util/Set;
