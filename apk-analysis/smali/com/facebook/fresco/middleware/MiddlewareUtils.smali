...
.method public static final obtainExtras(Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Landroid/graphics/Rect;Ljava/lang/String;Landroid/graphics/PointF;Ljava/util/Map;Ljava/lang/Object;ZLandroid/net/Uri;)Lcom/facebook/fresco/ui/common/ControllerListener2$Extras;
    .locals 2
    .param p0, "componentAttribution"    # Ljava/util/Map;
    .param p1, "shortcutAttribution"    # Ljava/util/Map;
    .param p2, "dataSourceExtras"    # Ljava/util/Map;
    .param p3, "imageSourceExtras"    # Ljava/util/Map;
    .param p4, "viewportDimensions"    # Landroid/graphics/Rect;
    .param p5, "scaleType"    # Ljava/lang/String;
    .param p6, "focusPoint"    # Landroid/graphics/PointF;
    .param p7, "imageExtras"    # Ljava/util/Map;
    .param p8, "callerContext"    # Ljava/lang/Object;
    .param p9, "logWithHighSamplingRate"    # Z
    .param p10, "mainUri"    # Landroid/net/Uri;
    ...
    .line 38
    iget v1, p6, Landroid/graphics/PointF;->y:F
