...
.method public final createOrNull(Ljava/io/File;)Lcom/facebook/binaryresource/FileBinaryResource;
    ...
    .line 44
    .local v2, "$i$a$-let-FileBinaryResource$Companion$createOrNull$1":I
    new-instance v3, Lcom/facebook/binaryresource/FileBinaryResource;

    invoke-direct {v3, v1, v0}, Lcom/facebook/binaryresource/FileBinaryResource;-><init>(Ljava/io/File;Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    move-object v0, v3

    .end local v1    # "it":Ljava/io/File;
    .end local v2    # "$i$a$-let-FileBinaryResource$Companion$createOrNull$1":I
    :cond_0
    return-object v0
.end method
