...
.method public setProxyOverride(Landroidx/webkit/ProxyConfig;Ljava/util/concurrent/Executor;Ljava/lang/Runnable;)V
    ...
    invoke-static {v1}, Landroidx/webkit/internal/ProxyControllerImpl;->proxyRulesToStringArray(Ljava/util/List;)[[Ljava/lang/String;

    move-result-object v1

    .line 43
    .local v1, "proxyRuleArray":[[Ljava/lang/String;
    ...
    .line 44
    .local v2, "bypassRuleArray":[Ljava/lang/String;
    invoke-direct {p0}, Landroidx/webkit/internal/ProxyControllerImpl;->getBoundaryInterface()Lorg/chromium/support_lib_boundary/ProxyControllerBoundaryInterface;

    move-result-object v3

    invoke-interface {v3, v1, v2, p3, p2}, Lorg/chromium/support_lib_boundary/ProxyControllerBoundaryInterface;->setProxyOverride([[Ljava/lang/String;[Ljava/lang/String;Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V

    .line 46
    .end local v1    # "proxyRuleArray":[[Ljava/lang/String;
    .end local v2    # "bypassRuleArray":[Ljava/lang/String;
    nop
