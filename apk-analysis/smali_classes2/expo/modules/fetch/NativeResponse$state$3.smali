...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v1, p0, Lexpo/modules/fetch/NativeResponse$state$3;->this$0:Lexpo/modules/fetch/NativeResponse;

    iget-object v2, p0, Lexpo/modules/fetch/NativeResponse$state$3;->$value:Lexpo/modules/fetch/ResponseState;

    invoke-direct {v0, v1, v2, p2}, Lexpo/modules/fetch/NativeResponse$state$3;-><init>(Lexpo/modules/fetch/NativeResponse;Lexpo/modules/fetch/ResponseState;Lkotlin/coroutines/Continuation;)V
...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Lexpo/modules/fetch/NativeResponse$state$3;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lexpo/modules/fetch/NativeResponse$state$3;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 28
    .local v0, "this":Lexpo/modules/fetch/NativeResponse$state$3;
    .local p1, "$result":Ljava/lang/Object;
    iget-object v1, v0, Lexpo/modules/fetch/NativeResponse$state$3;->this$0:Lexpo/modules/fetch/NativeResponse;

    invoke-static {v1}, Lexpo/modules/fetch/NativeResponse;->access$getStateChangeOnceListeners$p(Lexpo/modules/fetch/NativeResponse;)Ljava/util/List;

    move-result-object v1

    new-instance v2, Lexpo/modules/fetch/NativeResponse$state$3$1;

    iget-object v3, v0, Lexpo/modules/fetch/NativeResponse$state$3;->$value:Lexpo/modules/fetch/ResponseState;

    invoke-direct {v2, v3}, Lexpo/modules/fetch/NativeResponse$state$3$1;-><init>(Lexpo/modules/fetch/ResponseState;)V
