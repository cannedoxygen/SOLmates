...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0, v1}, Lexpo/modules/keepawake/KeepAwakeModule$definition$lambda$3$$inlined$AsyncFunctionWithPromise$2;->invoke([Ljava/lang/Object;Lexpo/modules/kotlin/Promise;)V
...
.method public final invoke([Ljava/lang/Object;Lexpo/modules/kotlin/Promise;)V
    ...
    .line 616
    .local v2, "$i$a$-AsyncFunctionWithPromise-KeepAwakeModule$definition$1$1":I
    nop

    .line 617
    :try_start_0
    iget-object v3, p0, Lexpo/modules/keepawake/KeepAwakeModule$definition$lambda$3$$inlined$AsyncFunctionWithPromise$2;->this$0:Lexpo/modules/keepawake/KeepAwakeModule;
    ...
    new-instance v4, Lexpo/modules/keepawake/KeepAwakeModule$definition$1$1$1;

    invoke-direct {v4, v1}, Lexpo/modules/keepawake/KeepAwakeModule$definition$1$1$1;-><init>(Lexpo/modules/kotlin/Promise;)V

    check-cast v4, Ljava/lang/Runnable;

    invoke-interface {v3, v0, v4}, Lexpo/modules/core/interfaces/services/KeepAwakeManager;->activate(Ljava/lang/String;Ljava/lang/Runnable;)V
    :try_end_0
    ...
    .line 619
    .local v3, "ex":Lexpo/modules/core/errors/CurrentActivityNotFoundException;
    new-instance v4, Lexpo/modules/keepawake/ActivateKeepAwakeException;

    invoke-direct {v4}, Lexpo/modules/keepawake/ActivateKeepAwakeException;-><init>()V

    check-cast v4, Lexpo/modules/kotlin/exception/CodedException;

    invoke-interface {v1, v4}, Lexpo/modules/kotlin/Promise;->reject(Lexpo/modules/kotlin/exception/CodedException;)V

    .line 621
    .end local v3    # "ex":Lexpo/modules/core/errors/CurrentActivityNotFoundException;
    :goto_0
    nop
    ...
    .end local v2    # "$i$a$-AsyncFunctionWithPromise-KeepAwakeModule$definition$1$1":I
    nop
