...
.method private final getCurrentActivity()Landroid/app/Activity;
    ...
    .line 28
    :cond_1
    new-instance v1, Lexpo/modules/core/errors/CurrentActivityNotFoundException;

    invoke-direct {v1}, Lexpo/modules/core/errors/CurrentActivityNotFoundException;-><init>()V

    throw v1

    .line 24
    .end local v0    # "activityProvider":Lexpo/modules/core/interfaces/ActivityProvider;
    :cond_2
...
.method public activate(Ljava/lang/String;Ljava/lang/Runnable;)V
    ...
    .param p2, "done"    # Ljava/lang/Runnable;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lexpo/modules/core/errors/CurrentActivityNotFoundException;
        }
