...
.method public final invoke()Ljava/util/Map;
    ...
    .line 46
    iget-object v1, p0, Lexpo/modules/device/DeviceModule$definition$1$1;->$this_ModuleDefinition:Lexpo/modules/kotlin/modules/ModuleDefinitionBuilder;

    .local v1, "$this$invoke_u24lambda_u240":Lexpo/modules/kotlin/modules/ModuleDefinitionBuilder;
    iget-object v4, p0, Lexpo/modules/device/DeviceModule$definition$1$1;->this$0:Lexpo/modules/device/DeviceModule;

    const/4 v5, 0x0

    .line 47
    .local v5, "$i$a$-run-DeviceModule$definition$1$1$1":I
    ...
    invoke-static {v4}, Lexpo/modules/device/DeviceModule;->access$getContext(Lexpo/modules/device/DeviceModule;)Landroid/content/Context;
    ...
    .end local v1    # "$this$invoke_u24lambda_u240":Lexpo/modules/kotlin/modules/ModuleDefinitionBuilder;
    .end local v5    # "$i$a$-run-DeviceModule$definition$1$1$1":I
    ...
    .local v1, "$this$invoke_u24lambda_u241":Lexpo/modules/kotlin/modules/ModuleDefinitionBuilder;
    iget-object v4, p0, Lexpo/modules/device/DeviceModule$definition$1$1;->this$0:Lexpo/modules/device/DeviceModule;

    const/4 v5, 0x0

    .line 52
    .local v5, "$i$a$-run-DeviceModule$definition$1$1$2":I
    sget-object v6, Lexpo/modules/device/DeviceModule;->Companion:Lexpo/modules/device/DeviceModule$Companion;

    invoke-static {v4}, Lexpo/modules/device/DeviceModule;->access$getContext(Lexpo/modules/device/DeviceModule;)Landroid/content/Context;

    move-result-object v4

    invoke-static {v6, v4}, Lexpo/modules/device/DeviceModule$Companion;->access$getDeviceType(Lexpo/modules/device/DeviceModule$Companion;Landroid/content/Context;)Lexpo/modules/device/DeviceModule$DeviceType;

    move-result-object v4

    invoke-virtual {v4}, Lexpo/modules/device/DeviceModule$DeviceType;->getJSValue()I

    move-result v1

    .end local v1    # "$this$invoke_u24lambda_u241":Lexpo/modules/kotlin/modules/ModuleDefinitionBuilder;
    .end local v5    # "$i$a$-run-DeviceModule$definition$1$1$2":I
    invoke-static {v1}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;
    ...
    .line 54
    .local v6, "$i$a$-takeIf-DeviceModule$definition$1$1$3":I
    array-length v7, v5
    ...
    .end local v6    # "$i$a$-takeIf-DeviceModule$definition$1$1$3":I
