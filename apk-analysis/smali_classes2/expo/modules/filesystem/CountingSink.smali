...
.method public constructor <init>(Lokio/Sink;Lokhttp3/RequestBody;Lexpo/modules/filesystem/CountingRequestListener;)V
    ...
    .param p2, "requestBody"    # Lokhttp3/RequestBody;
    .param p3, "progressListener"    # Lexpo/modules/filesystem/CountingRequestListener;
...
.method public write(Lokio/Buffer;J)V
    ...
    .line 32
    iget-object v0, p0, Lexpo/modules/filesystem/CountingSink;->progressListener:Lexpo/modules/filesystem/CountingRequestListener;

    iget-wide v1, p0, Lexpo/modules/filesystem/CountingSink;->bytesWritten:J

    iget-object v3, p0, Lexpo/modules/filesystem/CountingSink;->requestBody:Lokhttp3/RequestBody;

    invoke-virtual {v3}, Lokhttp3/RequestBody;->contentLength()J

    move-result-wide v3

    invoke-interface {v0, v1, v2, v3, v4}, Lexpo/modules/filesystem/CountingRequestListener;->onProgress(JJ)V
