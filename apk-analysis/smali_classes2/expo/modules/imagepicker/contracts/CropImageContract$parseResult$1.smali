...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v2, p0, Lexpo/modules/imagepicker/contracts/CropImageContract$parseResult$1;->$targetUri:Landroid/net/Uri;
    ...
    invoke-direct {v0, v1, v2, v3, p2}, Lexpo/modules/imagepicker/contracts/CropImageContract$parseResult$1;-><init>(Lexpo/modules/imagepicker/contracts/CropImageContractOptions;Landroid/net/Uri;Landroid/content/ContentResolver;Lkotlin/coroutines/Continuation;)V
...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Lexpo/modules/imagepicker/contracts/CropImageContract$parseResult$1;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lexpo/modules/imagepicker/contracts/CropImageContract$parseResult$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Lexpo/modules/imagepicker/contracts/CropImageContract$parseResult$1;
    .local p1, "$result":Ljava/lang/Object;
    invoke-static {p1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V

    goto :goto_0

    .end local v0    # "this":Lexpo/modules/imagepicker/contracts/CropImageContract$parseResult$1;
    ...
    .local v1, "this":Lexpo/modules/imagepicker/contracts/CropImageContract$parseResult$1;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v2, v1, Lexpo/modules/imagepicker/contracts/CropImageContract$parseResult$1;->$input:Lexpo/modules/imagepicker/contracts/CropImageContractOptions;
    ...
    iget-object v3, v1, Lexpo/modules/imagepicker/contracts/CropImageContract$parseResult$1;->$targetUri:Landroid/net/Uri;

    invoke-static {v3}, Landroidx/core/net/UriKt;->toFile(Landroid/net/Uri;)Ljava/io/File;

    move-result-object v3

    iget-object v4, v1, Lexpo/modules/imagepicker/contracts/CropImageContract$parseResult$1;->$contentResolver:Landroid/content/ContentResolver;
    ...
    iput v6, v1, Lexpo/modules/imagepicker/contracts/CropImageContract$parseResult$1;->label:I

    invoke-static {v2, v3, v4, v5}, Lexpo/modules/imagepicker/ImagePickerUtilsKt;->copyExifData(Landroid/net/Uri;Ljava/io/File;Landroid/content/ContentResolver;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .end local v1    # "this":Lexpo/modules/imagepicker/contracts/CropImageContract$parseResult$1;
    .restart local v0    # "this":Lexpo/modules/imagepicker/contracts/CropImageContract$parseResult$1;
    :goto_0
    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
