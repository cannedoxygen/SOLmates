...
.method public constructor <init>(Lexpo/modules/kotlin/views/ViewManagerWrapperDelegate;)V
    .locals 1
    .param p1, "viewWrapperDelegate"    # Lexpo/modules/kotlin/views/ViewManagerWrapperDelegate;
...
.method protected createViewInstance(Lcom/facebook/react/uimanager/ThemedReactContext;)Landroid/view/View;
    ...
    invoke-virtual {v0, v1}, Lexpo/modules/kotlin/views/ViewManagerWrapperDelegate;->createView(Landroid/content/Context;)Landroid/view/View;
...
.method public getExportedCustomDirectEventTypeConstants()Ljava/util/Map;
    ...
    .line 49
    .local v0, "expoEvent":Ljava/util/Map;
    :cond_0
...
.method public getNativeProps()Ljava/util/Map;
    ...
    .line 36
    .local v5, "$i$a$-forEach-SimpleViewManagerWrapper$getNativeProps$1":I
    ...
    .line 37
    .local v7, "prop":Lexpo/modules/kotlin/views/AnyViewProp;
    invoke-static {v0}, Lkotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;)V

    invoke-virtual {v7}, Lexpo/modules/kotlin/views/AnyViewProp;->getType$expo_modules_core_debug()Lexpo/modules/kotlin/types/AnyType;

    move-result-object v8

    invoke-virtual {v8}, Lexpo/modules/kotlin/types/AnyType;->getKType()Lkotlin/reflect/KType;
    ...
    .line 53
    .end local v5    # "$i$a$-forEach-SimpleViewManagerWrapper$getNativeProps$1":I
    .end local v6    # "key":Ljava/lang/String;
    .end local v7    # "prop":Lexpo/modules/kotlin/views/AnyViewProp;
    nop
...
.method public updateProperties(Landroid/view/View;Lcom/facebook/react/uimanager/ReactStylesDiffMap;)V
    ...
    .line 20
    .local v0, "propsMap":Lcom/facebook/react/bridge/ReadableMap;
    invoke-virtual {p0}, Lexpo/modules/kotlin/views/SimpleViewManagerWrapper;->getViewWrapperDelegate()Lexpo/modules/kotlin/views/ViewManagerWrapperDelegate;

    move-result-object v1

    invoke-virtual {v1, p1, v0}, Lexpo/modules/kotlin/views/ViewManagerWrapperDelegate;->updateProperties(Landroid/view/View;Lcom/facebook/react/bridge/ReadableMap;)Ljava/util/List;
    ...
    new-instance v3, Lexpo/modules/kotlin/views/FilteredReadableMap;

    invoke-direct {v3, v0, v1}, Lexpo/modules/kotlin/views/FilteredReadableMap;-><init>(Lcom/facebook/react/bridge/ReadableMap;Ljava/util/List;)V
    ...
    .line 23
    invoke-super {p0, p1, v2}, Lcom/facebook/react/uimanager/SimpleViewManager;->updateProperties(Landroid/view/View;Lcom/facebook/react/uimanager/ReactStylesDiffMap;)V
