...
.method public convertFromDynamic(Lcom/facebook/react/bridge/Dynamic;Lexpo/modules/kotlin/AppContext;)Ljava/lang/Object;
    ...
    .line 94
    .local v1, "$i$a$-createTrivialTypeConverter-TypeConverterProviderImpl$createCachedConverters$boolTypeConverter$1":I
    invoke-interface {v0}, Lcom/facebook/react/bridge/Dynamic;->asBoolean()Z

    move-result v0

    .end local v0    # "it":Lcom/facebook/react/bridge/Dynamic;
    .end local v1    # "$i$a$-createTrivialTypeConverter-TypeConverterProviderImpl$createCachedConverters$boolTypeConverter$1":I
