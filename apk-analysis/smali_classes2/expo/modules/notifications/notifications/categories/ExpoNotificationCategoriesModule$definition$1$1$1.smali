...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0, v1}, Lexpo/modules/notifications/notifications/categories/ExpoNotificationCategoriesModule$definition$1$1$1;->invoke(ILandroid/os/Bundle;)V
...
.method public final invoke(ILandroid/os/Bundle;)V
    ...
    .line 70
    .local v1, "categories":Ljava/util/ArrayList;
    :goto_0
    if-nez p1, :cond_1
    ...
    .line 71
    iget-object v0, p0, Lexpo/modules/notifications/notifications/categories/ExpoNotificationCategoriesModule$definition$1$1$1;->$promise:Lexpo/modules/kotlin/Promise;

    iget-object v2, p0, Lexpo/modules/notifications/notifications/categories/ExpoNotificationCategoriesModule$definition$1$1$1;->this$0:Lexpo/modules/notifications/notifications/categories/ExpoNotificationCategoriesModule;

    move-object v3, v1

    check-cast v3, Ljava/util/Collection;

    invoke-virtual {v2, v3}, Lexpo/modules/notifications/notifications/categories/ExpoNotificationCategoriesModule;->serializeCategories(Ljava/util/Collection;)Ljava/util/List;
    ...
    .line 73
    :cond_1
    iget-object v2, p0, Lexpo/modules/notifications/notifications/categories/ExpoNotificationCategoriesModule$definition$1$1$1;->$promise:Lexpo/modules/kotlin/Promise;

    const-string v3, "ERR_CATEGORIES_FETCH_FAILED"

    const-string v4, "A list of notification categories could not be fetched."
