...
.method public declared-synchronized getLock(Ljava/lang/Double;)Ljava/util/concurrent/atomic/AtomicReference;
    .locals 1
    .param p1, "lockIdentifier"    # Ljava/lang/Double;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/lang/Double;",
    ...
    .line 156
    .end local p0    # "this":Lcom/reactnativecommunity/webview/RNCWebViewModuleImpl$ShouldOverrideUrlLoadingLock;
    .end local p1    # "lockIdentifier":Ljava/lang/Double;
    :catchall_0
    move-exception p1
...
.method public declared-synchronized getNewLock()Landroidx/core/util/Pair;
    ...
    .line 150
    .local v2, "shouldOverride":Ljava/util/concurrent/atomic/AtomicReference;, "Ljava/util/concurrent/atomic/AtomicReference<Lcom/reactnativecommunity/webview/RNCWebViewModuleImpl$ShouldOverrideUrlLoadingLock$ShouldOverrideCallbackState;>;"
    ...
    .line 147
    .end local v0    # "lockIdentifier":D
    .end local v2    # "shouldOverride":Ljava/util/concurrent/atomic/AtomicReference;, "Ljava/util/concurrent/atomic/AtomicReference<Lcom/reactnativecommunity/webview/RNCWebViewModuleImpl$ShouldOverrideUrlLoadingLock$ShouldOverrideCallbackState;>;"
    .end local p0    # "this":Lcom/reactnativecommunity/webview/RNCWebViewModuleImpl$ShouldOverrideUrlLoadingLock;
    :catchall_0
    move-exception v0
