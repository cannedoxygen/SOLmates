...
.method private static copyFile(Ljava/io/FileInputStream;Ljava/io/FileOutputStream;)V
    .locals 9
    .param p0, "fromFile"    # Ljava/io/FileInputStream;
    .param p1, "toFile"    # Ljava/io/FileOutputStream;
    ...
    .line 139
    .local v1, "toChannel":Ljava/nio/channels/FileChannel;
    :try_start_0
...
.method private static getExpoDatabases(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    .line 72
    .local v0, "scopedDatabases":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/io/File;>;"
    :try_start_0
    ...
    .line 73
    .local v1, "databaseDirectory":Ljava/io/File;
    invoke-virtual {v1}, Ljava/io/File;->listFiles()[Ljava/io/File;

    move-result-object v2

    .line 74
    .local v2, "directoryListing":[Ljava/io/File;
    if-eqz v2, :cond_1
    ...
    const-string v7, "RKStorage-scoped-experience-"
    ...
    .line 85
    .end local v1    # "databaseDirectory":Ljava/io/File;
    .end local v2    # "directoryListing":[Ljava/io/File;
    :cond_1
    goto :goto_1
...
.method private static getLastModifiedFile(Ljava/util/ArrayList;)Ljava/io/File;
    ...
    .line 99
    .local v2, "lastModFile":Ljava/io/File;
...
.method public static migrate(Landroid/content/Context;)V
    ...
    .line 31
    .local v0, "expoDatabases":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/io/File;>;"
    ...
    .line 33
    .local v1, "expoDatabase":Ljava/io/File;
    const-string v2, "AsyncStorageExpoMigration"

    if-nez v1, :cond_1

    .line 34
    const-string v3, "No scoped database found"
    ...
    const-string v4, "Migrated most recently modified database "
    ...
    const-string v6, "Deleted scoped database "
    ...
    const-string v6, "Failed to delete scoped database "
    ...
    :goto_2
    const-string v3, "Completed the scoped AsyncStorage migration"
    ...
    const-string v5, "Failed to migrate scoped database "
