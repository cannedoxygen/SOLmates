...
.method public final createEventData(Lcom/swmansion/gesturehandler/core/GestureHandler;)Lcom/facebook/react/bridge/WritableMap;
    ...
    .local v1, "$this$createEventData_u24lambda_u243":Lcom/facebook/react/bridge/WritableMap;
    const/4 v2, 0x0

    .line 49
    .local v2, "$i$a$-apply-RNGestureHandlerTouchEvent$Companion$createEventData$1":I
    const-string v3, "handlerTag"
    ...
    .local v3, "it":Lcom/facebook/react/bridge/WritableArray;
    const/4 v5, 0x0

    .line 56
    .local v5, "$i$a$-let-RNGestureHandlerTouchEvent$Companion$createEventData$1$1":I
    ...
    invoke-interface {v1, v6, v7}, Lcom/facebook/react/bridge/WritableMap;->putArray(Ljava/lang/String;Lcom/facebook/react/bridge/ReadableArray;)V

    .line 57
    nop

    .line 55
    .end local v3    # "it":Lcom/facebook/react/bridge/WritableArray;
    .end local v5    # "$i$a$-let-RNGestureHandlerTouchEvent$Companion$createEventData$1$1":I
    nop
    ...
    .restart local v3    # "it":Lcom/facebook/react/bridge/WritableArray;
    const/4 v5, 0x0

    .line 60
    .local v5, "$i$a$-let-RNGestureHandlerTouchEvent$Companion$createEventData$1$2":I
    const-string v6, "allTouches"
    ...
    .line 59
    .end local v3    # "it":Lcom/facebook/react/bridge/WritableArray;
    .end local v5    # "$i$a$-let-RNGestureHandlerTouchEvent$Companion$createEventData$1$2":I
    nop
    ...
    .line 48
    .end local v1    # "$this$createEventData_u24lambda_u243":Lcom/facebook/react/bridge/WritableMap;
    .end local v2    # "$i$a$-apply-RNGestureHandlerTouchEvent$Companion$createEventData$1":I
...
.method public final obtain(Lcom/swmansion/gesturehandler/core/GestureHandler;)Lcom/swmansion/gesturehandler/react/RNGestureHandlerTouchEvent;
    ...
    .local v1, "$this$obtain_u24lambda_u240":Lcom/swmansion/gesturehandler/react/RNGestureHandlerTouchEvent;
    const/4 v2, 0x0

    .line 45
    .local v2, "$i$a$-apply-RNGestureHandlerTouchEvent$Companion$obtain$1":I
    invoke-static {v1, p1}, Lcom/swmansion/gesturehandler/react/RNGestureHandlerTouchEvent;->access$init(Lcom/swmansion/gesturehandler/react/RNGestureHandlerTouchEvent;Lcom/swmansion/gesturehandler/core/GestureHandler;)V

    .line 46
    nop

    .line 44
    .end local v1    # "$this$obtain_u24lambda_u240":Lcom/swmansion/gesturehandler/react/RNGestureHandlerTouchEvent;
    .end local v2    # "$i$a$-apply-RNGestureHandlerTouchEvent$Companion$obtain$1":I
    nop
