...
.method private final declared-synchronized detachHandler(Lcom/swmansion/gesturehandler/core/GestureHandler;)V
    ...
    .line 55
    .local v0, "attachedToView":Ljava/lang/Integer;
    if-eqz v0, :cond_0
    ...
    .line 58
    .local v1, "attachedHandlers":Ljava/util/ArrayList;
    if-eqz v1, :cond_0
    ...
    .line 60
    .local v2, "$i$a$-synchronized-RNGestureHandlerRegistry$detachHandler$1":I
    :try_start_1
    ...
    .line 59
    .end local v2    # "$i$a$-synchronized-RNGestureHandlerRegistry$detachHandler$1":I
    :try_start_2
    monitor-exit v1
    ...
    .line 64
    iget-object v2, p0, Lcom/swmansion/gesturehandler/react/RNGestureHandlerRegistry;->handlersForView:Landroid/util/SparseArray;
    ...
    .line 59
    .end local p0    # "this":Lcom/swmansion/gesturehandler/react/RNGestureHandlerRegistry;
    :catchall_0
    move-exception v2
    ...
    .line 68
    .end local v1    # "attachedHandlers":Ljava/util/ArrayList;
    :cond_0
    :goto_0
    ...
    .line 72
    new-instance v1, Lcom/swmansion/gesturehandler/react/RNGestureHandlerRegistry$$ExternalSyntheticLambda0;

    invoke-direct {v1, p1}, Lcom/swmansion/gesturehandler/react/RNGestureHandlerRegistry$$ExternalSyntheticLambda0;-><init>(Lcom/swmansion/gesturehandler/core/GestureHandler;)V
    ...
    .line 53
    .end local v0    # "attachedToView":Ljava/lang/Integer;
    .end local p1    # "handler":Lcom/swmansion/gesturehandler/core/GestureHandler;
    :catchall_1
    move-exception p1
...
.method private static final detachHandler$lambda$4(Lcom/swmansion/gesturehandler/core/GestureHandler;)V
    .locals 1
    .param p0, "$handler"    # Lcom/swmansion/gesturehandler/core/GestureHandler;
...
.method private final declared-synchronized registerHandlerForViewWithTag(ILcom/swmansion/gesturehandler/core/GestureHandler;)V
    .locals 4
    .param p1, "viewTag"    # I
    .param p2, "handler"    # Lcom/swmansion/gesturehandler/core/GestureHandler;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
            "Lcom/swmansion/gesturehandler/core/GestureHandler<",
    ...
    .local v0, "listToAdd":Ljava/lang/Object;
    iget-object v2, p0, Lcom/swmansion/gesturehandler/react/RNGestureHandlerRegistry;->handlersForView:Landroid/util/SparseArray;
    ...
    .line 47
    .local v1, "$i$a$-synchronized-RNGestureHandlerRegistry$registerHandlerForViewWithTag$2":I
    :try_start_1
    move-object v2, v0
    ...
    .line 46
    .end local v1    # "$i$a$-synchronized-RNGestureHandlerRegistry$registerHandlerForViewWithTag$2":I
    :try_start_2
    monitor-exit v0
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1
    ...
    .line 102
    .end local v0    # "listToAdd":Ljava/lang/Object;
    :cond_2
    const/4 v0, 0x0

    .line 38
    .local v0, "$i$a$-check-RNGestureHandlerRegistry$registerHandlerForViewWithTag$1":I
    ...
    .end local v0    # "$i$a$-check-RNGestureHandlerRegistry$registerHandlerForViewWithTag$1":I
    ...
    .end local p2    # "handler":Lcom/swmansion/gesturehandler/core/GestureHandler;
    :catchall_1
    move-exception p1
...
.method public final declared-synchronized attachHandlerToView(III)Z
    ...
    .local v1, "it":Lcom/swmansion/gesturehandler/core/GestureHandler;
    const/4 v2, 0x0

    .line 29
    .local v2, "$i$a$-let-RNGestureHandlerRegistry$attachHandlerToView$1":I
    ...
    .line 30
    invoke-virtual {v0, p3}, Lcom/swmansion/gesturehandler/core/GestureHandler;->setActionType(I)V

    .line 31
    invoke-direct {p0, p2, v0}, Lcom/swmansion/gesturehandler/react/RNGestureHandlerRegistry;->registerHandlerForViewWithTag(ILcom/swmansion/gesturehandler/core/GestureHandler;)V
    :try_end_0
    ...
    .line 28
    .end local v1    # "it":Lcom/swmansion/gesturehandler/core/GestureHandler;
    .end local v2    # "$i$a$-let-RNGestureHandlerRegistry$attachHandlerToView$1":I
    const/4 v1, 0x1
    ...
    .end local p1    # "handlerTag":I
    .end local p2    # "viewTag":I
    .end local p3    # "actionType":I
    :catchall_0
    move-exception p1
...
.method public final declared-synchronized dropHandler(I)V
    ...
    .local v0, "it":Lcom/swmansion/gesturehandler/core/GestureHandler;
    const/4 v1, 0x0

    .line 79
    .local v1, "$i$a$-let-RNGestureHandlerRegistry$dropHandler$1":I
    invoke-direct {p0, v0}, Lcom/swmansion/gesturehandler/react/RNGestureHandlerRegistry;->detachHandler(Lcom/swmansion/gesturehandler/core/GestureHandler;)V

    .line 80
    iget-object v2, p0, Lcom/swmansion/gesturehandler/react/RNGestureHandlerRegistry;->handlers:Landroid/util/SparseArray;
    ...
    .line 78
    .end local v0    # "it":Lcom/swmansion/gesturehandler/core/GestureHandler;
    .end local v1    # "$i$a$-let-RNGestureHandlerRegistry$dropHandler$1":I
    nop
...
.method public declared-synchronized getHandlersForView(Landroid/view/View;)Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v0}, Lcom/swmansion/gesturehandler/react/RNGestureHandlerRegistry;->getHandlersForViewWithTag(I)Ljava/util/ArrayList;
