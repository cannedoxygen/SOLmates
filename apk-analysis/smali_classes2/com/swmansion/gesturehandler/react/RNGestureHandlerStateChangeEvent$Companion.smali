...
.method public final createEventData(Lcom/swmansion/gesturehandler/react/eventbuilders/GestureHandlerEventDataBuilder;II)Lcom/facebook/react/bridge/WritableMap;
    .locals 4
    .param p1, "dataBuilder"    # Lcom/swmansion/gesturehandler/react/eventbuilders/GestureHandlerEventDataBuilder;
    .param p2, "newState"    # I
    .param p3, "oldState"    # I
    ...
    .local v1, "$this$createEventData_u24lambda_u241":Lcom/facebook/react/bridge/WritableMap;
    const/4 v2, 0x0

    .line 72
    .local v2, "$i$a$-apply-RNGestureHandlerStateChangeEvent$Companion$createEventData$1":I
    invoke-static {v1}, Lkotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;)V

    invoke-virtual {p1, v1}, Lcom/swmansion/gesturehandler/react/eventbuilders/GestureHandlerEventDataBuilder;->buildEventData(Lcom/facebook/react/bridge/WritableMap;)V
    ...
    invoke-interface {v1, v3, p3}, Lcom/facebook/react/bridge/WritableMap;->putInt(Ljava/lang/String;I)V

    .line 75
    nop

    .line 71
    .end local v1    # "$this$createEventData_u24lambda_u241":Lcom/facebook/react/bridge/WritableMap;
    .end local v2    # "$i$a$-apply-RNGestureHandlerStateChangeEvent$Companion$createEventData$1":I
...
.method public final obtain(Lcom/swmansion/gesturehandler/core/GestureHandler;IILcom/swmansion/gesturehandler/react/eventbuilders/GestureHandlerEventDataBuilder;)Lcom/swmansion/gesturehandler/react/RNGestureHandlerStateChangeEvent;
    ...
    .param p2, "newState"    # I
    .param p3, "oldState"    # I
    .param p4, "dataBuilder"    # Lcom/swmansion/gesturehandler/react/eventbuilders/GestureHandlerEventDataBuilder;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Lcom/swmansion/gesturehandler/core/GestureHandler<",
    ...
    .local v1, "$this$obtain_u24lambda_u240":Lcom/swmansion/gesturehandler/react/RNGestureHandlerStateChangeEvent;
    const/4 v2, 0x0

    .line 64
    .local v2, "$i$a$-apply-RNGestureHandlerStateChangeEvent$Companion$obtain$1":I
    invoke-static {v1, p1, p2, p3, p4}, Lcom/swmansion/gesturehandler/react/RNGestureHandlerStateChangeEvent;->access$init(Lcom/swmansion/gesturehandler/react/RNGestureHandlerStateChangeEvent;Lcom/swmansion/gesturehandler/core/GestureHandler;IILcom/swmansion/gesturehandler/react/eventbuilders/GestureHandlerEventDataBuilder;)V

    .line 65
    nop

    .line 63
    .end local v1    # "$this$obtain_u24lambda_u240":Lcom/swmansion/gesturehandler/react/RNGestureHandlerStateChangeEvent;
    .end local v2    # "$i$a$-apply-RNGestureHandlerStateChangeEvent$Companion$obtain$1":I
    nop
