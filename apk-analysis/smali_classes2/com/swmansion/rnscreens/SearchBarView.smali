...
.method public constructor <init>(Lcom/facebook/react/bridge/ReactContext;)V
    ...
    iput-object v0, p0, Lcom/swmansion/rnscreens/SearchBarView;->inputType:Lcom/swmansion/rnscreens/SearchBarView$SearchBarInputTypes;
    ...
    iput-object v0, p0, Lcom/swmansion/rnscreens/SearchBarView;->autoCapitalize:Lcom/swmansion/rnscreens/SearchBarView$SearchBarAutoCapitalize;

    .line 28
    const-string v0, ""

    iput-object v0, p0, Lcom/swmansion/rnscreens/SearchBarView;->placeholder:Ljava/lang/String;

    .line 29
    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/swmansion/rnscreens/SearchBarView;->shouldOverrideBackButton:Z

    .line 31
    iput-boolean v0, p0, Lcom/swmansion/rnscreens/SearchBarView;->shouldShowHintSearchIcon:Z
    ...
    iput v0, p0, Lcom/swmansion/rnscreens/SearchBarView;->surfaceId:I
...
.method public static final synthetic access$getScreenStackFragment(Lcom/swmansion/rnscreens/SearchBarView;)Lcom/swmansion/rnscreens/ScreenStackFragment;
    .locals 1
    .param p0, "$this"    # Lcom/swmansion/rnscreens/SearchBarView;
...
.method public static final synthetic access$setSearchViewFormatter$p(Lcom/swmansion/rnscreens/SearchBarView;Lcom/swmansion/rnscreens/SearchViewFormatter;)V
    .locals 0
    .param p0, "$this"    # Lcom/swmansion/rnscreens/SearchBarView;
    .param p1, "<set-?>"    # Lcom/swmansion/rnscreens/SearchViewFormatter;
...
.method private final getHeaderConfig()Lcom/swmansion/rnscreens/ScreenStackHeaderConfig;
    ...
    .line 40
    .local v0, "currentParent":Landroid/view/ViewParent;
    ...
    invoke-virtual {v1}, Lcom/swmansion/rnscreens/ScreenStackHeaderSubview;->getConfig()Lcom/swmansion/rnscreens/ScreenStackHeaderConfig;
...
.method private final handleFocusChange(Z)V
    ...
    new-instance v0, Lcom/swmansion/rnscreens/events/SearchBarFocusEvent;
    ...
    invoke-direct {v0, v1, v2}, Lcom/swmansion/rnscreens/events/SearchBarFocusEvent;-><init>(II)V

    goto :goto_0

    :cond_0
    new-instance v0, Lcom/swmansion/rnscreens/events/SearchBarBlurEvent;
    ...
    invoke-direct {v0, v1, v2}, Lcom/swmansion/rnscreens/events/SearchBarBlurEvent;-><init>(II)V
...
.method private static final setSearchViewListeners$lambda$0(Lcom/swmansion/rnscreens/SearchBarView;Landroid/view/View;Z)V
    .locals 0
    .param p0, "this$0"    # Lcom/swmansion/rnscreens/SearchBarView;
    .param p2, "hasFocus"    # Z
...
.method private final setSearchViewProps()V
    ...
    .line 56
    .local v0, "searchView":Lcom/swmansion/rnscreens/CustomSearchView;
    :goto_0
    if-eqz v0, :cond_7
...
.method private final setToolbarElementsVisibility(I)V
    ...
    invoke-virtual {v1}, Lcom/swmansion/rnscreens/ScreenStackHeaderConfig;->getConfigSubviewsCount()I
    ...
    invoke-virtual {v2, v0}, Lcom/swmansion/rnscreens/ScreenStackHeaderConfig;->getConfigSubview(I)Lcom/swmansion/rnscreens/ScreenStackHeaderSubview;
    ...
    .line 166
    .local v2, "subview":Lcom/swmansion/rnscreens/ScreenStackHeaderSubview;
    :goto_2
    if-eqz v2, :cond_2
    ...
    .line 164
    .end local v2    # "subview":Lcom/swmansion/rnscreens/ScreenStackHeaderSubview;
    :cond_4
    :goto_3
    if-eq v0, v1, :cond_5
...
.method public final handleSetTextJsRequest(Ljava/lang/String;)V
    ...
    .line 156
    .local v1, "$i$a$-let-SearchBarView$handleSetTextJsRequest$1":I
    invoke-direct {p0}, Lcom/swmansion/rnscreens/SearchBarView;->getScreenStackFragment()Lcom/swmansion/rnscreens/ScreenStackFragment;
    ...
    invoke-virtual {v2}, Lcom/swmansion/rnscreens/ScreenStackFragment;->getSearchView()Lcom/swmansion/rnscreens/CustomSearchView;

    move-result-object v2

    if-eqz v2, :cond_0

    invoke-virtual {v2, v0}, Lcom/swmansion/rnscreens/CustomSearchView;->setText(Ljava/lang/String;)V

    .line 157
    .end local v0    # "it":Ljava/lang/String;
    .end local v1    # "$i$a$-let-SearchBarView$handleSetTextJsRequest$1":I
    :cond_0
    return-void
.end method
...
.method public final setAutoCapitalize(Lcom/swmansion/rnscreens/SearchBarView$SearchBarAutoCapitalize;)V
    .locals 1
    .param p1, "<set-?>"    # Lcom/swmansion/rnscreens/SearchBarView$SearchBarAutoCapitalize;
...
.method public final setInputType(Lcom/swmansion/rnscreens/SearchBarView$SearchBarInputTypes;)V
    .locals 1
    .param p1, "<set-?>"    # Lcom/swmansion/rnscreens/SearchBarView$SearchBarInputTypes;
